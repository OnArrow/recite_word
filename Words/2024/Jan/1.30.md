...
1. horizontal **[ˌhɒrɪˈzɒnt(ə)l]** `adj` 水平的；横向的 `n` 水平线
    ```
...
12. threshold **[ˈθreʃhəʊld]** `n` 门槛；阈值
    ```
    He stepped across the threshold
    他迈过了门槛
    ```

13. drug **[drʌɡ]** `n` 药品；毒品
    ```
...
16. interval **[ˈɪntəv(ə)l]** `n` 间隔，间隙；区间
    ```
