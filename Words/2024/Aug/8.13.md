...
10. enthusiast **[ɪnˈθjuːziæst]** `n` 爱好者
    ```
    He is a great sports enthusiast.
    他是个真正的体育爱好者
    ```

11. admire **[ədˈmaɪə(r)]** `v` 钦佩，仰慕；欣赏
    ```
...
14. reception **[rɪˈsepʃ(ə)n]** `n` 招待会；接待处
    ```
...
16. bomber **[ˈbɒmə(r)]** `n` 轰炸机
    ```
    The bomber scored a direct hit on the bridge.
    轰炸机直接炸中了那座桥
    ```

17. ventilation **[ˌventɪˈleɪʃn]** `n` 通风；通风系统
    ```
