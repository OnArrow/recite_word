...
2. vegetarian **[ˌvedʒəˈteəriən]** `n` 素食者；素食主义者
    ```
...
6. celsius **[ˈselsiəs]** `n` 摄氏度
    ```
    Night temperatures can drop below 15 degree Celsius
    夜间温度可能会降到15摄氏度以下
    ```

7. population **[ˌpɒpjuˈleɪʃ(ə)n]** `n` 族群；（地区、国家的）人口
    ```
...
9. degree **[dɪˈɡriː]** `n` 度；（角的）度数，角度；温度；程度
    ```
...
16. redemption **[rɪˈdempʃn]** `n` （基督教）救赎，赎罪
    ```
