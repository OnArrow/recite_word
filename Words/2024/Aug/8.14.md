...
14. altogether **[ˌɔːltəˈɡeðə(r)]** `adv` 总共
    ```
...
18. disappoint **[ˌdɪsəˈpɔɪnt]** `v` 使失望
    ```
...
20. importance **[ɪmˈpɔːt(ə)ns]** `n` 重要；重要性
    ```
