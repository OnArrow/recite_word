...
4. atmosphere **[ˈætməsfɪə(r)]** `n` 气氛，氛围；大气层
    ```
    The atmosphere of Mars could not support life.
    生命无法在火星的大气层内生存
    ```

5. faulty **[ˈfɔːlti]** `adj` 有故障的；有错误的
    ```
