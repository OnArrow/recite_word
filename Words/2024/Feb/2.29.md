...
1. sunny **[ˈsʌni]** `adj` 阳光充足的；晴朗的；（性格）开朗的
    ```
...
5. independent **[ˌɪndɪˈpendənt]** `adj` 独立的，自治的；有主见的
    ```
...
19. trade **[treɪd]** `n` 贸易；营业额；交易 `v` 做生意；交易
    ```
    America's trade gap widened
    美国的贸易差额加大了
    ```

20. even **[ˈiːv(ə)n]** `adv` 甚至，即使
    ```
