...
3. unimaginative **[ˌʌnɪˈmædʒɪnətɪv]** `adj` 缺乏想象力的
    ```
...
5. footstep **[ˈfʊtstep]** `n` 脚步，足迹
    ```
    It's hard to follow on her footstep.
    追寻她的足迹很困难
    ```

6. shame **[ʃeɪm]** `n` 羞耻，惭愧
    ```
    He bowed his head in shame.
    他惭愧地低下头
    ```

7. observatory **[əbˈzɜːvətri]** `n` 天文台；气象台
    ```
...
10. meantime **[ˈmiːntaɪm]** `n` 其间；同时 `adv` 在此期间
    ```
...
14. microphone **[ˈmaɪkrəfəʊn]** `n` 麦克风
    ```
