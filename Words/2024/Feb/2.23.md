...
1. repetition **[ˌrepəˈtɪʃ(ə)n]** `n` 重复；反复
    ```
...
8. sanitize **[ˈsænɪtaɪz]** `vt` 给...消毒；对...采取卫生措施
    ```
...
11. classical **[ˈklæsɪk(ə)l]** `adj` 经典的，传统的；古典的
    ```
...
16. celsius **[ˈselsiəs]** `n` 摄氏度
    ```
    Night temperatures can drop below 15 degree Celsius
    夜间温度可能会降到15摄氏度以下
    ```

17. findable **[ˈfaɪndəbl]** `adj` 可发现的

18. comb **[kəʊm]** `v` 梳理 `n` 梳子；发卡
    ```
