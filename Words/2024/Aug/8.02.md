...
3. guilty **[ˈɡɪlti]** `adj` 内疚的；羞愧的
    ```
    I felt a wee bit guilty about it.
    我对此觉得有点惭愧
    ```

4. scornfully **[ˈskɔːnfəli]** `adv` 轻蔑地；蔑视地
    ```
...
10. granted **[ˈɡrɑːntɪd]** `v` （grant 的过去式） `adv` 的确；想当然
    ```
...
19. handsome **[ˈhænsəm]** `adj` （男子）英俊的；（女子）端庄的；漂亮的
    ```
    He used to be so handsome.
    他曾经是那么英俊
    ```

20. body **[ˈbɒdi]** `n` 身体；尸体
    ```
