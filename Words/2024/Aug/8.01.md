...
2. trunk **[trʌŋk]** `n` （汽车）后备箱；箱子；树干
    ```
    Bags should be put in the trunk.
    行李要放在后备箱里
    ```

3. revealer **[rɪˈvi:lə]** `n` 探测器
    ```
...
6. ridden **[ˈrɪdn]** `v` （ride 的过去分词）

7. seashore **[ˈsiːʃɔː(r)]** `n` 海岸
    ```
...
11. soil **[sɔɪl]** `n` 泥土，土壤
    ```
    The body was hidden beneath a thin layer of soil.
    尸体被埋藏在薄薄的一层土下
    ```

12. confident **[ˈkɒnfɪdənt]** `adj` 充满信心的
    ```
    She sounded more confident than she felt.
    她的语气听起来比她本人的感觉更有信心
    ```

13. rather **[ˈrɑːðə(r)]** `adv` 而不是；宁愿；相当
    ```
    She'd rather die than give a speech.
    她宁愿死也不愿意演讲
    ```

14. treasure **[ˈtreʒə(r)]** `n` 金银财宝，财宝
    ```
