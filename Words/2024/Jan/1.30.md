...
3. horizontal **[ˌhɒrɪˈzɒnt(ə)l]** `adj` 水平的；横向的 `n` 水平线
    ```
    I'd like to discuss with you this horizontal portion
    我想和你讨论一下这个横向部分
    ```

4. printer **[ˈprɪntə(r)]** `n` 打印机
    ```
...
15. ratio **[ˈreɪʃiəʊ]** `n` 比例
    ```
    The ratio between the two sides is one to four
    双方人数对比是一比四
    ```

16. transparent **[trænsˈpærənt]** `adj` 透明的，清澈的
    ```
