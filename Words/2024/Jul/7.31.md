...
6. currency **[ˈkʌrənsi]** `n` 货币
    ```
    When will the single currency be operable?
    什么时候实行单一货币？
    ```

7. ambition **[æmˈbɪʃ(ə)n]** `n` 雄心，野心；抱负
    ```
...
12. numerous **[ˈnjuːmərəs]** `adj` 众多的，许多的
    ```
    He has been late on numerous occasions.
    他已经迟到过无数次了
    ```

13. annoying **[əˈnɔɪɪŋ]** `adj` 令人恼火的
    ```
...
19. batter **[ˈbætə(r)]** `v` 殴打；连续猛打；严重破坏
    ```
