...
5. especially **[ɪˈspeʃəli]** `adv` 尤其，特别；专门
    ```
...
8. waitress **[ˈweɪtrəs]** `n` 女服务员
    ```
    She took a job as a waitress
    她找了个工作，当服务员
    ```

9. offset **[ˈɒfset]** `n` 偏移量 `v` 使...偏移
...
13. avenger **[əˈvendʒə(r)]** `n` 复仇者

14. jacket **[ˈdʒækɪt]** `n` 夹克
    ```
