...
2. paragraph **[ˈpærəɡrɑːf]** `n` （文章）段落
    ```
...
4. even **[ˈiːv(ə)n]** `adv` 甚至，即使；更加，愈加
    ```
    Even the poor have their pride
    即使穷人也有他们的自尊
    ```

5. beginning **[bɪˈɡɪnɪŋ]** `n` 开端；起源

6. exclude **[ɪkˈskluːd]** `vt` 把...排除在外
    ```
    You can exclude projects from this process if you wish
    如果需要，可以将项目排除在这个过程之外
    ```

7. bistro **[ˈbiːstrəʊ]** `n` 小酒馆
    ```
...
18. safely **[ˈseɪfli]** `adv` 安全地
    ```
    The pilot landed the plane safely
    飞行员驾驶飞机安全着陆
    ```

19. painting **[ˈpeɪntɪŋ]** `n` 绘画；画
    ```
