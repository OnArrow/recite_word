...
4. terrify **[ˈterɪfaɪ]** `v` 使害怕
    ```
    He always do that to terrify people.
    他常常这样子吓唬人
    ```

5. factor **[ˈfæktə(r)]** `n` 因素
    ```
    This cannot be the only factor.
    这不可能是唯一因素
    ```

6. sarcastic **[sɑːˈkæstɪk]** `adj` 讽刺的
    ```
...
12. binoculars **[bɪˈnɒkjələz]** `n` 双筒望远镜
    ```
