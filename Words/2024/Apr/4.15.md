...
4. occupied **[ˈɒkjupaɪd]** `adj` 忙于...的；（床、椅子、房间等）已被占用的；（地方）被占领的
    ```
...
16. mission **[ˈmɪʃ(ə)n]** `n` 军事行动；重要任务
    ```
