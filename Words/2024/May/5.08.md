...
3. exchange **[ɪksˈtʃeɪndʒ]** `n` 电话交换台，电话局
...
6. government **[ˈɡʌvənmənt]** `n` 政府
    ```
    The government took swift action
    政府立即采取了行动
    ```

7. Olympic **[əˈlɪmpɪk]** `adj` 奥林匹克运动会的
    ```
...
14. continually **[kənˈtɪnjuəli]** `adv` 不断地；连续地
    ```
...
16. bitterly **[ˈbɪtəli]** `adv` 极其寒冷地，刺骨地
    ```
    It's been bitterly cool here in Moscow
    在莫斯科，天气一直极其寒冷
    ```

17. honest **[ˈɒnɪst]** `adj` 诚实的
    ```
    I know she's honest and reliable
    我相信她是诚实可靠的
    ```

18. certain **[sɜːt(ə)n]** `adj` 某个；无疑的
    ```
