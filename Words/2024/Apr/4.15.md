...
2. attend **[əˈtend]** `v` 陪同，随同；照料
    ```
    We were made to attend meetings every day
    我们每天都被迫参加会议
    ```

3. occupied **[ˈɒkjupaɪd]** `adj` 忙于...的；（床、椅子、房间等）已被占用的；（地方）被占领的
    ```
...
8. rung **[rʌŋ]** `v` （ring 的过去分词）

9. certificate **[səˈtɪfɪkət]** `n` 证明，证书 `v` 发证书给...
    ```
...
15. attractive **[əˈtræktɪv]** `adj` 吸引人的
    ```
...
19. rescue **[ˈreskjuː]** `v` 营救，援救 `n` 营救
    ```
    We had given up hope of rescue
    我们那时已经放弃了获救的希望
    ```

20. lord **[lɔːd]** `n` 上帝；主，主人；领主，庄园主
    ```
