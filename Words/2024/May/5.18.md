...
1. implicitly **[ɪmˈplɪsɪtli]** `adv` 暗含地
    ```
...
11. crossword **[ˈkrɒswɜːd]** `n` 填字谜游戏
    ```
    I sat down and began doing the crossword
    坐下后我开始做字谜游戏
    ```

12. breezy **[ˈbriːzi]** `adj` 微风的；通风好的
    ```
    It was a lazy, breezy autumn afternoon
    这是一个懒散的，起风的秋日下午
    ```

13. married **[ˈmærid]** `adj` 已婚的
    ```
...
17. endless **[ˈendləs]** `adj` 无止境的，无休止的
    ```
...
20. arrange **[əˈreɪndʒ]** `v` 布置，整理；安排
    ```
