...
5. helpful **[ˈhelpf(ə)l]** `adj` 乐于助人的；有用的
    ```
    She made helpful comments on my work
    她对我的工作提出了有益的意见
    ```

6. lighthouse **[ˈlaɪthaʊs]** `n` 灯塔
    ```
...
14. drew **[druː]** `v` （draw 的过去式）

15. employer **[ɪmˈplɔɪə(r)]** `n` 雇主
    ```
