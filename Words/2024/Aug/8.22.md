...
1. sank **[sæŋk]** `v` （sink 的过去式）

2. macaroni **[ˌmækəˈrəʊni]** `n` 空心面
    ```
...
18. announcer **[əˈnaʊnsə(r)]** `n` 播音员
    ```
    The announcer apologized for the delay.
    播音员为晚点道了歉
    ```

19. survivor **[səˈvaɪvə(r)]** `n` 幸存者
    ```
