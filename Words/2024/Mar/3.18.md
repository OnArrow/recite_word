...
1. critically **[ˈkrɪtɪkli]** `adv` 批判性地
    ```
...
4. campfire **[ˈkæmpfaɪə(r)]** `n` 篝火；营火
    ```
...
10. soundly **[ˈsaʊndli]** `adv` 香甜地
    ```
    She is sleeping soundly
    她睡得正香
    ```

11. wound **[wuːnd]** `v` （wind 的过去式）

12. standard **[ˈstændəd]** `n` 规范；（品质的）标准
    ```
