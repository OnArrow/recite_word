...
1. swagger **[ˈswæɡə(r)]** `adj` 漂亮的

2. then **[ðen]** `adv` （指过去）当时；（指将来）到那时；然后；
    ```
...
9. silly **[ˈsɪli]** `adj` 愚蠢的；傻的
    ```
    We had to wear these silly little hats
    我们不得不戴这些傻里傻气的小帽子
    ```

10. dangerous **[ˈdeɪndʒərəs]** `adj` 危险的
    ```
...
18. fantastic **[fænˈtæstɪk]** `adj` 极好的，非常棒的；极大的
    ```
