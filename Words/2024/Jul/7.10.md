...
5. varchar **[ˈvɑːtʃɑː]** `n` 文本类型；可变长字符串

6. breast **[brest]** `n` 乳房；胸部
    ```
...
8. republic **[rɪˈpʌblɪk]** `n` 共和国
    ```
    In 1918, Austria became a republic.
    1918年，奥地利成为共和国
    ```

9. conclusion **[kənˈkluːʒn]** `n` 结论
    ```
...
13. pornographic **[ˌpɔːnəˈɡræfɪk]** `adj` 色情的
    ```
...
17. unsigned **[ˌʌnˈsaɪnd]** `adj` 未签名的；无符号的
    ```
