...
4. unsmiling **[ˌʌnˈsmaɪlɪŋ]** `adj` 严肃的；不笑的
    ```
    He was unsmiling and silent
    他十分严肃，一言不发
    ```

5. despair **[dɪˈspeə(r)]** `n` 绝望
    ```
...
13. certain **[sɜːt(ə)n]** `adj` 某个；无疑的
    ```
...
16. sunshine **[ˈsʌnʃaɪn]** `n` 阳光
    ```
    This room gets very little sunshine
    这个房间几乎照不进阳光
    ```

17. continually **[kənˈtɪnjuəli]** `adv` 不断地；连续地
    ```
...
20. Olympic **[əˈlɪmpɪk]** `adj` 奥林匹克运动会的
    ```
