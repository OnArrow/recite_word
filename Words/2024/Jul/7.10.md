...
5. unsigned **[ˌʌnˈsaɪnd]** `adj` 未签名的；无符号的
...
9. average **[ˈævərɪdʒ]** `n` 平均值 `adj` 平均的
...
17. stupidity **[stjuːˈpɪdəti]** `n` 愚蠢；愚蠢想法
...
20. descending **[dɪˈsendɪŋ]** `adj` 降序的，递降的

21. varchar **[ˈvɑːtʃɑː]** `n` 文本类型；可变长字符串
