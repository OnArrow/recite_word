...
1. lit **[lɪt]** `v` （light 的过去式）

2. amusement **[əˈmjuːzmənt]** `n` 开心；娱乐
    ```
...
4. peculiar **[pɪˈkjuːliə(r)]** `adj` 奇怪的，不寻常的
    ```
    I had a peculiar feeling we'd met before.
    我有一种奇怪的感觉，觉得我们之前见过
    ```

5. christ **[kraɪst]** `n` 救世主；基督
    ```
