...
2. participate **[pɑːˈtɪsɪpeɪt]** `v` 参加，参与
    ```
...
12. visa **[ˈviːzə]** `n` 信用卡；签证
    ```
    Do you need a visa for the USA?
    你需要美国签证吗？
    ```

13. collar **[ˈkɒlə(r)]** `n` 衣领
    ```
...
21. reflect **[rɪˈflekt]** `v` 反射（光、热）；引起（某种）看法
    ```
