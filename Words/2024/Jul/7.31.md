...
1. pastry **[ˈpeɪstri]** `n` 糕点；点心；面糊
    ```
    The bread, pastry and mayonnaise are homemade.
    面包，糕点和蛋黄酱都是自家做的
    ```

2. clothing **[ˈkləʊðɪŋ]** `n` 衣服
    ```
...
5. critical **[ˈkrɪtɪk(ə)l]** `adj` 批判性的
    ```
...
7. doorknob **[ˈdɔːnɒb]** `n` 门把手
    ```
    You all just fell and hit the doorknob right?
    你仅仅是跌倒刚好撞到了门把手是吗？
    ```

8. annoying **[əˈnɔɪɪŋ]** `adj` 令人恼火的
    ```
...
10. dismay **[dɪsˈmeɪ]** `v` （使）失望；（使）沮丧 `n` 失望
    ```
...
12. batter **[ˈbætə(r)]** `v` 殴打；连续猛打；严重破坏
    ```
    These problems will certainly batter her image.
    这些问题当然会破红她的形象
    ```

13. burst **[bɜːst]** `v` 爆裂，爆炸；胀开
    ```
    Her head felt as if it would burst.
    她觉得头要裂开了
    ```

14. numerous **[ˈnjuːmərəs]** `adj` 众多的，许多的
    ```
...
19. bother **[ˈbɒðə(r)]** `v` （使）烦恼；打扰
    ```
    Sorry to bother you, but there's a call for you on line two.
    很抱歉打扰你，二号线有你的电话
    ```

20. receiver **[rɪˈsiːvə(r)]** `n` （电话）听筒；接收器
    ```
