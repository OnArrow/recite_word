...
5. sanitize **[ˈsænɪtaɪz]** `vt` 给...消毒；对...采取卫生措施
    ```
...
7. vegetarian **[ˌvedʒəˈteəriən]** `n` 素食者；素食主义者
    ```
    A growing number of people are going vegetarian
    越来越多的人开始吃素了
    ```

8. capital **[ˈkæpɪt(ə)l]** `n` 首都，首府；资本，资本家
    ```
...
17. degree **[dɪˈɡriː]** `n` 度；（角的）度数，角度；温度；学位
    ```
