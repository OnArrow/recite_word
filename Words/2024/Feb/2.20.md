...
6. cool **[kuːl]** `adj` 凉爽的；酷的，时髦的；冷静的 `v` （使）变凉
    ```
...
19. stain **[steɪn]** `n` 污渍，污点 `v` 被...留下污渍
    ```
