...
5. following **[ˈfɒləʊɪŋ]** `adj` 之后的，接下来的 `n` 追随者
    ```
    The band has a huge following in Italy
    这个乐队在意大利有一大批热心的追随者
    ```

6. honest **[ˈɒnɪst]** `adj` 诚实的
    ```
...
12. Olympic **[əˈlɪmpɪk]** `adj` 奥林匹克运动会的
    ```
...
18. successful **[səkˈsesf(ə)l]** `adj` 成功的
    ```
