...
1. overtime **[ˈəʊvətaɪm]** `n` 加班时间；加时赛
    ```
    This new order will mean working overtime
    这新订单意味着要加班
    ```

2. blonde **[blɒnd]** `adj` 金黄色的
    ```
...
4. deadline **[ˈdedlaɪn]** `n` 最后期限，截止日期
    ```
...
9. nursery **[ˈnɜːsəri]** `n` 托儿所；幼儿园
    ```
    Her youngest child is at nursery now
    她最小的孩子现在上托儿所
    ```

10. anyway **[ˈeniweɪ]** `adv` 不管怎样，无论如何
    ```
