...
3. hung **[hʌŋ]** `v` （hang 的过去式）

4. madness **[ˈmædnəs]** `n` 疯狂；疯子
    ```
    When did all this madness begin?
    这种疯狂是从什么时候开始？
    ```

5. crept **[krept]** `v` （creep 的过去式）

6. campfire **[ˈkæmpfaɪə(r)]** `n` 篝火；营火
    ```
...
15. upside **[ˈʌpsaɪd]** `n` 上边
    ```
    The painting was hung upside down
    这幅画挂颠倒了
    ```

16. cursor **[ˈkɜːsə(r)]** `n` 光标；指针
    ```
...
21. thunder **[ˈθʌndə(r)]** `v` 打雷 `n` 雷；雷声
    ```
