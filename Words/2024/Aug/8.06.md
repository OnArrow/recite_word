...
3. crystal **[ˈkrɪst(ə)l]** `n` 水晶
    ```
    I could see the whole of the sky which was as clear as crystal.
    我可以看到整个天空，清澈如水晶一般
    ```

4. NASA **[ˈnæsə]** `abbr` 美国国家航空和宇宙航行局

5. endeavour **[ɪnˈdevə(r)]** `n` （航天飞机）奋进号；努力
    ```
...
7. shuttle **[ˈʃʌt(ə)l]** `n` 航天飞机
    ```
    The countdown has begun for the launch of the space shuttle.
    航天飞机发射前的倒计时已经开始
    ```

8. atmosphere **[ˈætməsfɪə(r)]** `n` 气氛，氛围；大气层
    ```
...
13. national **[ˈnæʃ(ə)nəl]** `adj` 国家的
    ```
...
15. aeronautics **[ˌeərəˈnɔːtɪks]** `n` 航空学
    ```
    Aeronautics enables us to overcome great distances.
    航空学使我们能征服远距离
    ```

16. astronaut **[ˈæstrənɔːt]** `n` 宇航员
    ```
