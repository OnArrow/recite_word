...
1. spray **[spreɪ]** `v` 喷洒，喷射；喷农药
    ```
    He spray-painted his name on the wall.
    他把自己的名字喷涂在墙上
    ```

2. authority **[ɔːˈθɒrəti]** `n` 官方，当局；权利
    ```
...
6. desolate **[ˈdesələt]** `adj` 荒凉的，荒无人烟的
    ```
    Numerous factories have sprung up in this once desolate area.
    过去这一带荒无人烟，现在却有无数工厂
    ```

7. blacken **[ˈblækən]** `vt` 使变黑；诽谤
    ```
