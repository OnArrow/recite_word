...
16. reflect **[rɪˈflekt]** `v` 反射（光、热）；引起（某种）看法
    ```
    The ocean would reflect more heat and light
    海洋会反射更多的光和热
    ```

17. participate **[pɑːˈtɪsɪpeɪt]** `v` 参加，参与
    ```
