...
5. atmosphere **[ˈætməsfɪə(r)]** `n` 气氛，氛围；大气层
    ```
...
8. teller **[telə(r)]** `n` （银行）出纳员；讲述者，讲故事的人
    ```
...
18. telescope **[ˈtelɪskəʊp]** `n` 望远镜
    ```
    The telescope was pointing in the wrong direction.
    望远镜对错了方向
    ```

19. faulty **[ˈfɔːlti]** `adj` 有故障的；有错误的
    ```
    Ask for a refund if the goods are faulty.
    商品如有缺陷，可要求退款
    ```

20. bark **[bɑːk]** `v` 狗叫；吼叫
    ```
