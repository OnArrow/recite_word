...
1. lately **[ˈleɪtli]** `adv` 最近
    ```
    She's been very edgy lately
    她最近一直烦躁不安
    ```

2. pyramid **[ˈpɪrəmɪd]** `n` 金字塔
    ```
...
18. even **[ˈiːv(ə)n]** `adv` 甚至，即使；更加，愈加
    ```
    Even the poor have their pride
    即使穷人也有他们的自尊
    ```

19. paragraph **[ˈpærəɡrɑːf]** `n` （文章）段落
    ```
