...
1. unsigned **[ˌʌnˈsaɪnd]** `adj` 未签名的；无符号的
    ```
...
3. descending **[dɪˈsendɪŋ]** `adj` 降序的，递降的
...
11. conclusion **[kənˈkluːʒn]** `n` 结论
    ```
    The judge's conclusion was plainly wrong.
    法官的结论显然是错误的
    ```

12. distinct **[dɪˈstɪŋkt]** `adj` 不同的，有区别的
    ```
