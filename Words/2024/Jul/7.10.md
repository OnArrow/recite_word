...
1. stupidity **[stjuːˈpɪdəti]** `n` 愚蠢；愚蠢想法
    ```
...
7. alter **[ˈɔːltə(r)]** `v` 改变，改动
    ```
    It doesn't alter the way I feel.
    这并没有改变我的感受
    ```

8. theory **[ˈθɪəri]** `n` 理论
    ```
    The theory remains untested.
    该理论仍未经过验证
    ```

9. abnormal **[æbˈnɔːm(ə)l]** `adj` 不规则的；反常的
    ```
    They thought his behavior was abnormal.
    他们认为他行为反常
    ```

10. ascending **[əˈsendɪŋ]** `adj` 升序的，上升的
...
13. biography **[baɪˈɒɡrəfi]** `n` 传记；生平
    ```
...
16. scientist **[ˈsaɪəntɪst]** `n` 科学家
    ```
    He's a brilliant young scientist.
    他是一个才华横溢的青年科学家
    ```

17. species **[ˈspiːʃiːz]** `n` 物种
    ```
