...
5. robbery **[ˈrɒbəri]** `n` 盗窃；抢劫
    ```
    A man has been arrested in connection with the robbery.
    一名男子因与这桩抢劫案有关已被逮捕
    ```

6. calm **[kɑːm]** `adj` 镇定的；冷静的 `v` 使镇定
    ```
...
15. briefcase **[ˈbriːfkeɪs]** `n` 公文包
    ```
    He rifled through his briefcase and extracted a file.
    他在公文包内搜索一番，取出一份文件
    ```

16. importance **[ɪmˈpɔːt(ə)ns]** `n` 重要；重要性
    ```
...
19. altogether **[ˌɔːltəˈɡeðə(r)]** `adv` 总共
    ```
