...
3. social **[ˈsəʊʃ(ə)l]** `adj` 社会的；社交的
    ```
...
9. communicate **[kəˈmjuːnɪkeɪt]** `v` 传递（想法或感情）
    ```
...
22. construct **[kənˈstrʌkt]** `v` 建造；构造
    ```
