...
6. accidentally **[ˌæksɪˈdentəli]** `adv` 意外地；偶然地
    ```
...
9. excursion **[ɪkˈskɜːʃn]** `n` 短途旅行，远足
    ```
...
14. volt **[vəʊlt]** `n` 伏特（电压单位）
    ```
    That is one electron volt
    就是一单位的电子伏特
    ```

15. temporarily **[ˈtemprərəli]** `adv` 暂时地，临时地
    ```
