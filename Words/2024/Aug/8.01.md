...
4. revealer **[rɪˈvi:lə]** `n` 探测器
    ```
    The new machine called 'The revealer' has been invented.
    一种叫探测器的机器已经被发明出来了
    ```

5. rather **[ˈrɑːðə(r)]** `adv` 而不是；宁愿
    ```
...
10. worthless **[ˈwɜːθləs]** `adj` 毫无价值的
    ```
...
16. trunk **[trʌŋk]** `n` （汽车）后备箱
    ```
    Bags should be put in the trunk.
    行李要放在后备箱里
    ```

17. bury **[ˈberi]** `v` 埋藏；填埋
    ```
...
19. led **[led]** `v` （lead 的过去式）

20. treasure **[ˈtreʒə(r)]** `n` 金银财宝，财宝
    ```
