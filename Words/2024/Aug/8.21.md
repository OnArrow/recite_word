...
3. horsepower **[ˈhɔːspaʊə(r)]** `n` （功率单位）马力
    ```
    Our horsepower was less than half that of the winner.
    我们的马力还不到获胜者的一半
    ```

4. sympathetically **[ˌsɪmpəˈθetɪkli]** `adv` 同情地
    ```
...
10. erect **[ɪˈrekt]** `v` 搭建
    ```
    They plan to erect an apartment house on that property.
    他们计划在那块地产上建造一座公寓
    ```

11. observatory **[əbˈzɜːvətri]** `n` 天文台；气象台
    ```
