...
8. distinct **[dɪˈstɪŋkt]** `adj` 不同的，有区别的
    ```
...
10. breast **[brest]** `n` 乳房；胸部
    ```
    She put the baby to her breast.
    她开始给婴儿哺乳
    ```

11. species **[ˈspiːʃiːz]** `n` 物种
    ```
    This species is extremely rare.
    这一物种极其罕见
    ```

12. descending **[dɪˈsendɪŋ]** `adj` 降序的，递降的

13. ascending **[əˈsendɪŋ]** `adj` 升序的，上升的

14. biography **[baɪˈɒɡrəfi]** `n` 传记；生平
    ```
