...
6. countryside **[ˈkʌntrisaɪd]** `n` 乡村，农村
    ```
...
10. bore **[bɔː(r)]** `v` （bear 的过去式）；使厌烦，使讨厌
    ```
...
14. hovercraft **[ˈhɒvəkrɑːft]** `n` 气垫船
    ```
