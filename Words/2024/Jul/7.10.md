...
2. ascending **[əˈsendɪŋ]** `adj` 升序的，上升的

3. truncate **[trʌŋˈkeɪt]** `v` 截断，删节

4. biography **[baɪˈɒɡrəfi]** `n` 传记；生平
    ```
...
6. varchar **[ˈvɑːtʃɑː]** `n` 文本类型；可变长字符串
...
20. abnormal **[æbˈnɔːm(ə)l]** `adj` 不规则的；反常的
    ```
