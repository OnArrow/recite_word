...
1. contents **[ˈkɒntents]** `n` 容纳的东西，内有的物品
    ```
...
6. implicitly **[ɪmˈplɪsɪtli]** `adv` 暗含地
    ```
...
10. arrange **[əˈreɪndʒ]** `v` 布置，整理；安排
    ```
    Can I arrange appointment for Monday?
    我可以安排周一约吗？
    ```

11. savings **[ˈseɪvɪŋz]** `n` 存款
    ```
