...
4. appetite **[ˈæpɪtaɪt]** `n` 食欲，胃口
    ```
    Go for a walk, it'll give you an appetite.
    去散散步，你就有食欲了。
    ```

5. elderly **[ˈeldəli]** `adj` 上了年纪的
    ```
...
7. suffer **[ˈsʌfə(r)]** `v` （因疾病、痛苦、悲伤等）受苦，受折磨
    ```
...
13. rapidly **[ˈræpɪdli]** `adv` 迅速地
    ```
    Crime figures are rising rapidly.
    犯罪数字正在快速上升。
    ```

14. machinery **[məˈʃiːnəri]** `n` 机器，机械（尤指大型机械）
    ```
