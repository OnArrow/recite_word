...
2. tremendous **[trəˈmendəs]** `adj` 巨大的
...
7. advertiser **[ˈædvətaɪzə(r)]** `n` 报幕员；广告商
...
11. swung **[swʌŋ]** `v` （swing 的过去式）

12. trap **[træp]** `v` 陷入（危险、困境） `n` 陷阱
...
18. smoothly **[ˈsmuːðli]** `adv` 平稳地；顺利地
