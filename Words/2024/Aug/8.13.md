...
1. reception **[rɪˈsepʃ(ə)n]** `n` 招待会；接待处
    ```
...
17. continent **[ˈkɒntɪnənt]** `n` 洲；大陆
    ```
...
20. rediscover **[ˌriːdɪˈskʌvə(r)]** `vt` 重新发现
    ```
