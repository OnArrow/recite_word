...
1. nervous **[ˈnɜːvəs]** `adj` 神经紧张的，紧张不安的
    ```
    I was too nervous to eat
    我紧张得饭都吃不下
    ```

2. kick **[kɪk]** `v` 踢，踢腿 `n` 踢
    ```
...
5. affixes **[əˈfɪksɪz]** `n` 词缀
    ```
    The affixes of adjectives are large and diverse
    形容词的词缀大且多样
    ```

6. countdown **[ˈkaʊntdaʊn]** `n` 倒计时
    ```
    The countdown has begun
    倒计时已经开始
    ```

7. nowadays **[ˈnaʊədeɪz]** `adv` 如今，现在
    ```
...
10. rare **[reə(r)]** `adj` 三分熟；罕见的，不常发生的
    ```
    I specifically asked for this steak rare
    我明确要求把这份牛排做成三分熟
    ```

11. stable **[ˈsteɪb(ə)l]** `adj` 稳定的，牢固的 `n` 马棚
    ```
...
13. department **[dɪˈpɑːtmənt]** `n` 部门
    ```
...
19. mistaken **[mɪˈsteɪkən]** `adj` （想法、观点）不正确的 `v` （mistake 的过去分词）
    ```
