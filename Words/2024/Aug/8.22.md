...
4. helicopter **[ˈhelɪkɒptə(r)]** `n` 直升飞机
    ```
...
6. survivor **[səˈvaɪvə(r)]** `n` 幸存者
    ```
    This soldier was the sole survivor of the battle.
    这名士兵是这场战斗唯一的幸存者
    ```

7. precaution **[prɪˈkɔːʃ(ə)n]** `n` 预防措施
    ```
...
13. evade **[ɪˈveɪd]** `v` 逃避；逃离
    ```
    You wouldn't want us to evade our duty.
    你不想让我们逃避我的义务
    ```

14. scholarship **[ˈskɒləʃɪp]** `n` 奖学金
    ```
    He went to drama school on a scholarship.
    他靠奖学金上了戏剧学校
    ```

15. fool **[fuːl]** `n` 傻瓜，笨蛋
    ```
    You made me look a complete fool.
    你弄得我像一个十足的傻瓜
    ```

16. surely **[ˈʃʊəli]** `adv` （用于表明你相信某事极有可能）想必
    ```
...
18. sneer **[snɪə(r)]** `n` 嘲笑，讥讽
    ```
    I was uncomfortable with his sneer.
    他的嘲笑使我很不舒服
    ```

19. laid **[leɪd]** `v` （lay 的过去式）
