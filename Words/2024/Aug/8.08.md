...
1. century **[ˈsentʃəri]** `n` 世纪
    ```
    Jack originated this theory in the 17th century.
    Jack于17世纪创立了这个理论
    ```

2. quantity **[ˈkwɒntəti]** `n` 数量
    ```
...
4. authority **[ɔːˈθɒrəti]** `n` 官方，当局；权利
    ```
