...
4. final **[ˈfaɪn(ə)l]** `adj` 最终的 `n` 决赛；期末考试
    ```
    I'll text you the final score
    我会发短信告诉你最终比分
    ```

5. drawer **[drɔː(r)]** `n` 抽屉；开票人
    ```
...
14. mistaken **[mɪˈsteɪkən]** `adj` （想法、观点）不正确的 `v` （mistake 的过去分词）
    ```
    You are completely mistaken about Jack
    你对杰克的看法完全错了
    ```

15. affixes **[əˈfɪksɪz]** `n` 词缀
    ```
...
17. rare **[reə(r)]** `adj` 三分熟；罕见的，不常发生的
    ```
