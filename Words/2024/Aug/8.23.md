...
1. Egyptian **[iˈdʒɪpʃn]** `n` 埃及人 `adj` 埃及的
    ```
...
7. formal **[ˈfɔːm(ə)l]** `adj` （语言）正式的，规范的
    ```
    I felt ill at ease in such formal clothes.
    我穿着这样正式的衣服觉得很拘谨
    ```

8. normally **[ˈnɔːməli]** `adv` 通常地
    ```
    The child is developing normally.
    这孩子发育正常
    ```

9. thresh **[θreʃ]** `vt` 打谷；打庄稼
    ```
...
20. fancy **[ˈfænsi]** `v` （表示惊奇或震惊）真想不到，竟然
    ```
