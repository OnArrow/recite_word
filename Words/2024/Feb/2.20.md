...
3. improvement **[ɪmˈpruːvmənt]** `n` 改善；改进
    ```
...
15. journalist **[ˈdʒɜːnəlɪst]** `n` 新闻工作者
    ```
    She had taken him for a journalist
    她错把他当成记者了
    ```

16. round **[raʊnd]** `adj` 圆形的，球形的 `prep` 环绕，围绕
    ```
