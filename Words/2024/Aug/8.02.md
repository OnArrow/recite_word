...
1. natural **[ˈnætʃ(ə)rəl]** `adj` 天生的，真实的；天然的
    ```
...
3. handsome **[ˈhænsəm]** `adj` （男子）英俊的；（女子）端庄的；漂亮的
    ```
    He used to be so handsome.
    他曾经是那么英俊
    ```

4. guilty **[ˈɡɪlti]** `adj` 内疚的；羞愧的
    ```
...
14. explosion **[ɪkˈspləʊʒ(ə)n]** `n` 爆炸
    ```
