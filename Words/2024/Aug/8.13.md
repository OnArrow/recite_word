...
1. accompany **[əˈkʌmpəni]** `v` 陪伴，伴随
    ```
    Jack agreed to accompany me on a trip to Africa.
    杰克同意陪我去非洲旅行
    ```

2. circus **[ˈsɜːkəs]** `n` 马戏团
    ```
...
11. officially **[əˈfɪʃəli]** `adv` 正式地；官方地
    ```
...
14. enthusiast **[ɪnˈθjuːziæst]** `n` 爱好者
    ```
    He is a great sports enthusiast.
    他是个真正的体育爱好者
    ```

15. ventilate **[ˈventɪleɪt]** `v` 使通风
    ```
