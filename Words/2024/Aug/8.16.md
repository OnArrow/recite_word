...
3. violently **[ˈvaɪələntli]** `adv` 猛烈地
    ```
...
8. instruct **[ɪnˈstrʌkt]** `v` 指示，吩咐；指导
    ```
...
12. unbelievable **[ˌʌnbɪˈliːvəb(ə)l]** `adj` 难以置信的
    ```
    His guitar solos are just unbelievable.
    他的吉他独奏简直令人难以置信
    ```

13. murder **[ˈmɜːdə(r)]** `n` 谋杀；凶杀 `v` 谋杀
    ```
