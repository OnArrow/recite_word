...
8. unsigned **[ˌʌnˈsaɪnd]** `adj` 未签名的；无符号的
    ```
...
11. varchar **[ˈvɑːtʃɑː]** `n` 文本类型；可变长字符串

12. curious **[ˈkjʊəriəs]** `adj` 好奇的
    ```
    'I'm not meddling,' Jack said mildly, 'I'm just curious.'
    “我不是在管闲事，” 肯温和地说，“我只是好奇”
    ```

13. stupidity **[stjuːˈpɪdəti]** `n` 愚蠢；愚蠢想法
    ```
...
15. abnormal **[æbˈnɔːm(ə)l]** `adj` 不规则的；反常的
    ```
    They thought his behavior was abnormal.
    他们认为他行为反常
    ```

16. descending **[dɪˈsendɪŋ]** `adj` 降序的，递降的

17. theory **[ˈθɪəri]** `n` 理论
    ```
