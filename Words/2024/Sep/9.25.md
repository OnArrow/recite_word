...
4. extinguisher **[ɪkˈstɪŋɡwɪʃə(r)]** `n` 灭火器
    ```
...
15. underwater **[ˌʌndəˈwɔːtə(r)]** `adj` 水下的
    ```
...
19. frightful **[ˈfraɪtf(ə)l]** `adj` 可怕的
    ```
    This room is in a frightful mess.
    房间里乱七八糟
    ```

20. dirt **[dɜːt]** `n` 灰尘；尘土
    ```
