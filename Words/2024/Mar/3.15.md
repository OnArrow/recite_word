...
4. carousel **[ˌkærəˈsel]** `n` 旋转木马；走马灯
    ```
...
8. foreigner **[ˈfɒrənə(r)]** `n` 外国人
    ```
    You don't sound like a foreigner talking English
    你听起来不像外国人在说英语
    ```

9. whether **[ˈweðə(r)]** `conj` 是否（表示选择）；无论
    ```
    I asked whether they could change my ticket
    我问他们是否可以给我们换票
    ```

10. modern **[ˈmɒd(ə)n]** `adj` 当代风格的；摩登的，时髦的
    ```
...
15. district **[ˈdɪstrɪkt]** `n` 地区
    ```
    They have had a growing influence on the district
    他们对这个地区的影响越来越大
    ```

16. curtain **[ˈkɜːt(ə)n]** `n` 窗帘，门帘
    ```
