...
3. alter **[ˈɔːltə(r)]** `v` 改变，改动
    ```
    It doesn't alter the way I feel.
    这并没有改变我的感受
    ```

4. tiny **[ˈtaɪni]** `adj` 极小的，微小的
    ```
...
10. varchar **[ˈvɑːtʃɑː]** `n` 文本类型；可变长字符串
...
14. ascending **[əˈsendɪŋ]** `adj` 升序的，上升的
...
21. abnormal **[æbˈnɔːm(ə)l]** `adj` 不规则的；反常的
    ```
