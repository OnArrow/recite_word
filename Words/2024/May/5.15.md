...
2. helpful **[ˈhelpf(ə)l]** `adj` 乐于助人的；有用的
    ```
...
5. drew **[druː]** `v` （draw 的过去式）

6. pipe **[paɪp]** `n` 管子；（吹奏的）管乐器 `v` 用管道运输
    ```
...
8. lighthouse **[ˈlaɪthaʊs]** `n` 灯塔
    ```
    The light on the lighthouse suddenly went out
    灯塔上的灯突然灭了
    ```

9. resist **[rɪˈzɪst]** `v` 阻挡，抵挡；抵制
    ```
...
18. drawn **[drɔːn]** `v` (draw 的过去分词)

19. extraordinary **[ɪkˈstrɔːd(ə)n(ə)ri]** `adj` 异乎寻常的
    ```
    It's extraordinary that he managed to sleep through the party
    真想不到他竟然从聚会开始一直睡到结束
    ```

20. towel **[ˈtaʊəl]** `n` 毛巾
    ```
