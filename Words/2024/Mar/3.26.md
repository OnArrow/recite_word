...
4. hovercraft **[ˈhɒvəkrɑːft]** `n` 气垫船
    ```
...
7. probably **[ˈprɒbəbli]** `adv` 大概，或许
    ```
...
12. matrix **[ˈmeɪtrɪks]** `n` 矩阵；模型；线路网
    ```
    I will get back the same matrix
    我会得到一个相同的矩阵
    ```

13. bore **[bɔː(r)]** `v` （bear 的过去式）；使厌烦，使讨厌
    ```
    Monuments and museums bore him to tears
    纪念碑和博物馆让他厌烦透了
    ```

14. compose **[kəmˈpəʊz]** `v` 组成；作曲，撰写
    ```
