...
7. Britain **[ˈbrɪt(ə)n]** `n` 英国，不列颠(包括英格兰、苏格兰及威尔士)；
    ```
    When did the Romans invade Britain?
    古罗马人是何时侵略英国的?
    ```

8. announcer **[əˈnaʊnsə(r)]** `n` 播音员
    ```
...
11. fool **[fuːl]** `n` 傻瓜，笨蛋
    ```
    You made me look a complete fool.
    你弄得我像一个十足的傻瓜
    ```

12. precaution **[prɪˈkɔːʃ(ə)n]** `n` 预防措施
    ```
...
19. helicopter **[ˈhelɪkɒptə(r)]** `n` 直升飞机
    ```
