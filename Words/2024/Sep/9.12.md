...
2. election **[ɪˈlekʃ(ə)n]** `n` 选举；当选
    ```
    How did you vote at the last election?
    在上次选举中你是怎么投的票？
    ```

3. encouragement **[ɪnˈkʌrɪdʒmənt]** `n` 鼓励
    ```
...
10. gardening **[ˈɡɑːdnɪŋ]** `n` 园艺
    ```
    The conversation turned to gardening.
    话题转到了园艺上
    ```

11. contribute **[kənˈtrɪbjuːt]** `v` 捐赠；为...做贡献
    ```
    What kind of people can contribute more to them?
    什么样的人可以为他们贡献更多？
    ```

12. opponent **[əˈpəʊnənt]** `n` 对手，竞争者
    ```
...
16. fanatical **[fəˈnætɪkl]** `adj` 狂热的
    ```
...
18. volunteer **[ˌvɒlənˈtɪə(r)]** `v` 自愿做 `n` 志愿者
    ```
