...
7. flour **[ˈflaʊə(r)]** `n` 面粉
    ```
    Flour is sold by the kilogram
    面粉按公斤出售
    ```

8. union **[ˈjuːniən]** `n` 联邦；联合
...
17. reflect **[rɪˈflekt]** `v` 反射（光、热）；引起（某种）看法
    ```
