...
1. overlap **[ˌəʊvəˈlæp]** `v` 与...重叠 `n` 重叠
    ```
...
9. frighten **[ˈfraɪt(ə)n]** `v` （使）惊吓，（使）惊恐
    ```
...
11. healthy **[ˈhelθi]** `adj` 健康的，健壮的
    ```
    She was delivered of a healthy boy
    她生下了一个健康的男孩
    ```

12. rare **[reə(r)]** `adj` 半熟的；罕见的，不常发生的
    ```
...
15. stable **[ˈsteɪb(ə)l]** `adj` 稳定的，牢固的 `n` 马棚
    ```
...
18. ladder **[ˈlædə(r)]** `n` 梯子
    ```
    I fell off the ladder
    我从梯子上摔下来了
    ```

19. department **[dɪˈpɑːtmənt]** `n` 部门
    ```
