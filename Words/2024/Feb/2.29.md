...
1. beginning **[bɪˈɡɪnɪŋ]** `n` 开端；起源

2. cookery **[ˈkʊkəri]** `n` 烹饪
    ```
    This meal is typical of local cookery
    这是有当地风味的饭菜
    ```

3. exclude **[ɪkˈskluːd]** `vt` 把...排除在外
    ```
