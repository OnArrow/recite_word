...
8. receiver **[rɪˈsiːvə(r)]** `n` （电话）听筒；接收器
    ```
...
12. pastry **[ˈpeɪstri]** `n` 糕点；点心；面糊
    ```
    The bread, pastry and mayonnaise are homemade.
    面包，糕点和蛋黄酱都是自家做的
    ```

13. mix **[mɪks]** `v` （使）混合；调制 `n` 混音
    ```
...
20. battle **[ˈbæt(ə)l]** `v` 争吵；与...作战 `n` 战争
    ```
