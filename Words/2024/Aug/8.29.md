...
3. temper **[ˈtempə(r)]** `n` 坏脾气
    ```
    He needs to learn to curb his temper.
    他得学着控制自己的脾气。
    ```

4. suffer **[ˈsʌfə(r)]** `v` （因疾病、痛苦、悲伤等）受苦，受折磨
    ```
...
6. satisfaction **[ˌsætɪsˈfækʃ(ə)n]** `n` 满意，称心
    ```
...
9. delighted **[dɪˈlaɪtɪd]** `adj` 欣喜的；高兴的
    ```
...
13. machinery **[məˈʃiːnəri]** `n` 机器，机械（尤指大型机械）
    ```
