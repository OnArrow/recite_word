...
4. thunder **[ˈθʌndə(r)]** `v` 打雷 `n` 雷；雷声
    ```
...
7. cursor **[ˈkɜːsə(r)]** `n` 光标；指针
    ```
    He moves the cursor, clicks the mouse
    他移动光标，点击鼠标
    ```

8. upside **[ˈʌpsaɪd]** `n` 上边
    ```
...
16. critically **[ˈkrɪtɪkli]** `adv` 批判性地
    ```
