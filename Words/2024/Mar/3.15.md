...
1. modern **[ˈmɒd(ə)n]** `adj` 当代风格的；摩登的，时髦的
    ```
...
3. whether **[ˈweðə(r)]** `conj` 是否（表示选择）；无论
    ```
    I asked whether they could change my ticket
    我问他们是否可以给我们换票
    ```

4. several **[ˈsevrəl]** `pron` 几个；数个
    ```
...
7. appreciate **[əˈpriːʃieɪt]** `v` 欣赏，鉴赏
    ```
    Anyone can appreciate our music
    任何人都能欣赏我们的音乐
    ```

8. critic **[ˈkrɪtɪk]** `n` 批评家
    ```
...
12. determined **[dɪˈtɜːmɪnd]** `adj` 下定决心的；坚定的
    ```
...
14. handrail **[ˈhændreɪl]** `n` 扶手；栏杆
    ```
    For your safety, please hold the handrail
    为保安全，紧握扶手
    ```

15. mad **[mæd]** `adj` 发疯的 `n` 字幕版
    ```
...
20. beyond **[bɪˈjɒnd]** `prep` 超出（范围）；在...较远的另一边
    ```
