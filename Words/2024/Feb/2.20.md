...
4. journalist **[ˈdʒɜːnəlɪst]** `n` 新闻工作者
    ```
...
8. chopstick **[ˈtʃɒpstɪk]** `n` 筷子
    ```
    I need chopstick, knife, fork
    我需要筷子，刀，叉
    ```

9. cool **[kuːl]** `adj` 凉爽的；酷的，时髦的；冷静的 `v` （使）变凉
    ```
...
17. round **[raʊnd]** `adj` 圆形的，球形的 `prep` 环绕，围绕
    ```
