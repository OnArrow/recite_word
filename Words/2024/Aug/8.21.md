...
2. truant **[ˈtruːənt]** `n` 旷课的孩子，逃学的孩子 `v` 旷课，逃学
    ```
...
14. sympathetically **[ˌsɪmpəˈθetɪkli]** `adv` 同情地
    ```
...
16. parliament **[ˈpɑːləmənt]** `n` 议会；国会
    ```
    He was elected to Parliament as the Member for Leeds.
    他被选入国会作为利兹市的议员
    ```

17. horsepower **[ˈhɔːspaʊə(r)]** `n` （功率单位）马力
    ```
...
20. microphone **[ˈmaɪkrəfəʊn]** `n` 麦克风
    ```
