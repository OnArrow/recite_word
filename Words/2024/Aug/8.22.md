...
1. surely **[ˈʃʊəli]** `adv` （用于表明你相信某事极有可能）想必
    ```
...
4. signal **[ˈsɪɡnəl]** `n` 信号
    ```
    A radio signal was sent to the spacecraft.
    向宇宙飞船发出了信号
    ```

5. violent **[ˈvaɪələnt]** `adj` 暴力的；剧烈的
    ```
...
15. Britain **[ˈbrɪt(ə)n]** `n` 英国，不列颠(包括英格兰、苏格兰及威尔士)；
    ```
...
19. announcer **[əˈnaʊnsə(r)]** `n` 播音员
    ```
    The announcer apologized for the delay.
    播音员为晚点道了歉
    ```

20. fool **[fuːl]** `n` 傻瓜，笨蛋
    ```
