...
6. law **[lɔː]** `n` 法律（体系）；法学
    ```
    She's very widely read in law
    她在法律方面知识渊博
    ```

7. lottery **[ˈlɒtəri]** `n` 彩票；博彩
    ```
...
9. sunbathe **[ˈsʌnbeɪð]** `n` 日光浴 `v` 晒太阳
    ```
...
11. African **[ˈæfrɪkən]** `n` 非洲人 `adj` 非洲的；非洲人的
    ```
...
19. bin **[bɪn]** `n` 垃圾桶 `v` 把...扔进垃圾桶
    ```
    Put it in the bin
    把它扔进垃圾桶
    ```

20. outlaw **[ˈaʊtlɔː]** `n` 逃犯；不法之徒
    ```
