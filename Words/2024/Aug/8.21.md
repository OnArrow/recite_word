...
1. sympathetically **[ˌsɪmpəˈθetɪkli]** `adv` 同情地
    ```
...
6. parliament **[ˈpɑːləmənt]** `n` 议会；国会
    ```
...
8. racing **[ˈreɪsɪŋ]** `n` 竞赛
    ```
    He owns a string of racing stables.
    他有好多个赛马训练场
    ```

9. microphone **[ˈmaɪkrəfəʊn]** `n` 麦克风
    ```
...
20. horsepower **[ˈhɔːspaʊə(r)]** `n` （功率单位）马力
    ```
