...
3. bodyguard **[ˈbɒdiɡɑːd]** `n` 保镖；贴身保镖
    ```
    I thought he was a bodyguard
    我认为他是一个保镖
    ```

4. slew **[sluː]** `v` （slay 的过去式）

5. union **[ˈjuːniən]** `n` 联邦；联合
...
15. override **[ˌəʊvəˈraɪd]** `v` 覆盖；重写
    ```
...
18. international **[ˌɪntəˈnæʃ(ə)nəl]** `adj` 国际的
    ```
