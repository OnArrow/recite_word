...
4. handsome **[ˈhænsəm]** `adj` （男子）英俊的；（女子）端庄的；漂亮的
    ```
...
12. natural **[ˈnætʃ(ə)rəl]** `adj` 天生的，真实的；天然的
    ```
...
15. participle **[pɑːˈtɪsɪpl]** `n` （语法）分词
    ```
