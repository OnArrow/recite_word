...
4. movement **[ˈmuːvmənt]** `n` 动作；移动
    ```
    They were watching her every movement
    他们注视着她的每一个动作
    ```

5. pole **[pəʊl]** `n` 地极；磁极；杆
    ```
    The truck crashed into a telegraph pole
    卡车撞上了电线杆
    ```

6. freedom **[ˈfriːdəm]** `n` 自由权；自由
    ```
...
10. charmer **[ˈtʃɑːmə(r)]** `n` 魔术师
    ```
    'There's a picture of a snake charmer in this' he exclaimed
    “这里面有一张玩蛇者的照片” 他喊道
    ```

11. Indian **[ˈɪndiən]** `n` 印度人 `adj` 印度的
    ```
...
14. obviously **[ˈɒbviəsli]** `adv` （用于强调）显然
    ```
...
17. anxious **[ˈæŋkʃəs]** `adj` 焦虑的，担心的；紧张的
    ```
