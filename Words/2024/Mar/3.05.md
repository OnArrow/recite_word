...
3. won **[wʌn]** `v` （win 的过去式）

4. woke **[wəʊk]** `v` （wake 的过去式）
...
11. upstream **[ˌʌpˈstriːm]** `n` 上游 `adj` 逆流而上的
    ```
