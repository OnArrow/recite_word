...
1. raincoat **[ˈreɪnkəʊt]** `n` 雨衣
    ```
    A grey raincoat was folded over her arm.
    一件灰色的雨衣被折叠着搭在她的手臂上
    ```

2. calm **[kɑːm]** `adj` 镇定的；冷静的 `v` 使镇定
    ```
