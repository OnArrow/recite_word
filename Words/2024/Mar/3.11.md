...
3. international **[ˌɪntəˈnæʃ(ə)nəl]** `adj` 国际的
    ```
...
10. external **[ɪkˈstɜːn(ə)l]** `adj` 外部的
    ```
...
20. babysit **[ˈbeɪbisɪt]** `v` 临时照看婴儿
    ```
    Could you babysit for us on Friday?
    周五你能帮我们照看下孩子吗？
    ```

21. flour **[ˈflaʊə(r)]** `n` 面粉
    ```
