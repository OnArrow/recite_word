...
9. species **[ˈspiːʃiːz]** `n` 物种
    ```
    This species is extremely rare.
    这一物种极其罕见
    ```

10. conclusion **[kənˈkluːʒn]** `n` 结论
    ```
