...
4. piss **[pɪs]** `v` 小便，撒尿 `n` 尿
    ```
    He was fully clothed and covered in puke and piss.
    他全身沾满呕吐物和尿
    ```

5. earthquake **[ˈɜːθkweɪk]** `n` 地震
    ```
...
9. appropriate **[əˈprəʊpriət]** `adj` 合适的
    ```
    Choose appropriate programs for their children.
    为孩子选择合适的节目
    ```

10. annoyed **[əˈnɔɪd]** `adj` 恼怒的
    ```
