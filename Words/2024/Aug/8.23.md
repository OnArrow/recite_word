...
4. vacant **[ˈveɪkənt]** `adj` （地方）空着的；（职位）空缺的
    ```
...
16. magic **[ˈmædʒɪk]** `n` 魔法，法术 `adj` 神奇的
    ```
    They believe in magic.
    他们相信魔力
    ```

17. formal **[ˈfɔːm(ə)l]** `adj` （语言）正式的，规范的
    ```
