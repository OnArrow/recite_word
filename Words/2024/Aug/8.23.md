...
7. Egyptian **[iˈdʒɪpʃn]** `n` 埃及人 `adj` 埃及的
    ```
...
13. fancy **[ˈfænsi]** `v` （表示惊奇或震惊）真想不到，竟然
    ```
    Fancy! She's never been in a plane before.
    真想不到!她竟然从未坐过飞机
    ```

14. formal **[ˈfɔːm(ə)l]** `adj` （语言）正式的，规范的
    ```
...
17. mummy **[ˈmʌmi]** `n` 木乃伊
    ```
    The mummy has been buried.
    这木乃伊被填埋了
    ```

18. confess **[kənˈfes]** `v` 承认，坦白
    ```
