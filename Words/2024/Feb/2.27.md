...
9. forbade **[fəˈbæd]** `v` （forbid 的过去式）
...
11. forbidden **[fəˈbɪd(ə)n]** `v` （forbid 的过去分词） `adj` 禁止的
    ```
...
16. inbox **[ˈɪnbɒks]** `n` （电子邮件）收件箱
    ```
    There were four messages in my inbox
    我的收件箱里有四封邮件
    ```

17. sexy **[ˈseksi]** `adj` 性感的；引起性欲的
    ```
...
19. claim **[kleɪm]** `v` 索赔；认领 `n` 索赔；权力
    ```
