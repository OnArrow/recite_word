...
5. worthless **[ˈwɜːθləs]** `adj` 毫无价值的
    ```
...
13. arm **[ɑːm]** `n` 手臂 `v` 武装
    ```
    A snake was twisting around his arm.
    一条蛇缠绕在他的手臂上
    ```

14. advisor **[ədˈvaɪzə]** `n` 顾问；指导教师
    ```
...
18. rather **[ˈrɑːðə(r)]** `adv` 而不是；宁愿；相当
    ```
