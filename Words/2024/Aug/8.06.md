...
2. teller **[telə(r)]** `n` （银行）出纳员；讲述者，讲故事的人
    ```
    You become a mind reader and a fortune teller.
    你变成了一个揣摩别人心思的人，算命先生
    ```

3. latch **[lætʃ]** `n` 门拴，门闩；门中间那根控制开关的横木
    ```
...
6. faulty **[ˈfɔːlti]** `adj` 有故障的；有错误的
    ```
...
10. aeronautics **[ˌeərəˈnɔːtɪks]** `n` 航空学
    ```
    Aeronautics enables us to overcome great distances.
    航空学使我们能征服远距离
    ```

11. atmosphere **[ˈætməsfɪə(r)]** `n` 气氛，氛围；大气层
    ```
    The atmosphere of Mars could not support life.
    生命无法在火星的大气层内生存
    ```

12. NASA **[ˈnæsə]** `abbr` 美国国家航空和宇宙航行局

13. endeavour **[ɪnˈdevə(r)]** `n` （航天飞机）奋进号；努力
    ```
    Please make every endeavour to arrive on time.
    请尽全力按时到达
    ```

14. crystal **[ˈkrɪst(ə)l]** `n` 水晶
    ```
...
18. national **[ˈnæʃ(ə)nəl]** `adj` 国家的
    ```
    The building is part of our national heritage.
    这个建筑是我们民族遗产的一部分
    ```

19. bark **[bɑːk]** `v` 狗叫；吼叫
    ```
    Their dogs bark loudly.
    他们的狗大声吠叫
    ```

20. astronaut **[ˈæstrənɔːt]** `n` 宇航员
    ```
