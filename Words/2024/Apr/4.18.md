...
3. capable **[ˈkeɪpəb(ə)l]** `adj` 有能力的
    ```
...
12. lecture **[ˈlektʃə(r)]** `n` 演讲
    ```
    I found her lecture very obscure
    我发现她的演讲非常费解
    ```

13. poetry **[ˈpəʊətri]** `n` 诗歌
    ```
    Poetry isn't really my bag
    我其实并不擅长诗歌
    ```

14. nonsense **[ˈnɒns(ə)ns]** `n` 废话
    ```
...
16. congratulate **[kənˈɡrætʃəleɪt]** `v` 祝贺
    ```
