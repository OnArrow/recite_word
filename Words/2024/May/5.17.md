...
3. telegram **[ˈtelɪɡræm]** `n` 电报
    ```
    The president received a briefing by telegram
    总裁收到了一份电报简报
    ```

4. difference **[ˈdɪfrəns]** `n` 差异；区别
    ```
...
20. anxious **[ˈæŋkʃəs]** `adj` 焦虑的，担心的；紧张的
    ```
