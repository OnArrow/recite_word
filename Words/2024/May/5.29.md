...
1. twin **[twɪn]** `adj` 双胞胎的，孪生的 `n` 双胞胎之一
    ```
...
3. meanwhile **[ˈmiːnwaɪl]** `adv` 与此同时，同时
    ```
...
17. unnecessary **[ʌnˈnesəsəri]** `adj` 不必要的
    ```
...
19. confine **[kənˈfaɪn]** `v` 关押，监禁；局限
    ```
