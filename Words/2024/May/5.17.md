...
4. anxious **[ˈæŋkʃəs]** `adj` 焦虑的，担心的；紧张的
...
5. explanation **[ˌekspləˈneɪʃ(ə)n]** `n` 解释，说明
...
11. obviously **[ˈɒbviəsli]** `adv` （用于强调）显然
...
12. difference **[ˈdɪfrəns]** `n` 差异；区别
