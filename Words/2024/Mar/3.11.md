...
14. union **[ˈjuːniən]** `n` 联邦；联合

15. plain **[pleɪn]** `adj` 朴素的，无装饰的
    ```
...
21. international **[ˌɪntəˈnæʃ(ə)nəl]** `adj` 国际的
    ```
