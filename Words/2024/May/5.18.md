...
6. forest **[ˈfɒrɪst]** `n` 森林
    ```
    We need to preserve the forest
    我们需要保护森林
    ```

7. breezy **[ˈbriːzi]** `adj` 微风的；通风好的
    ```
...
9. strap **[stræp]** `n` 皮带，带子
    ```
    He looped the strap over his shoulder
    他把带子绕了一圈挎在肩上
    ```

10. possession **[pəˈzeʃ(ə)n]** `n` 所有物；个人财产
    ```
...
16. conscience **[ˈkɒnʃəns]** `n` 良心，良知
    ```
...
20. endless **[ˈendləs]** `adj` 无止境的，无休止的
    ```
