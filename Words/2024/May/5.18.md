...
14. strap **[stræp]** `n` 皮带，带子
    ```
    He looped the strap over his shoulder
    他把带子绕了一圈挎在肩上
    ```

15. aircraft **[ˈeəkrɑːft]** `n` 飞机
    ```
...
17. breezy **[ˈbriːzi]** `adj` 微风的；通风好的
    ```
    It was a lazy, breezy autumn afternoon
    这是一个懒散的，起风的秋日下午
    ```

18. implicitly **[ɪmˈplɪsɪtli]** `adv` 暗含地
    ```
