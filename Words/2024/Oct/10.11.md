...
4. temporary **[ˈtemprəri]** `adj` 临时的，暂时的
...
6. occupy **[ˈɒkjupaɪ]** `v` （军事）占领；居住；占据
...
11. unnatural **[ʌnˈnætʃrəl]** `adj` 不自然的
...
12. opportunity **[ˌɒpəˈtjuːnəti]** `n` 时机
...
19. anniversary **[ˌænɪˈvɜːsəri]** `n` 周年纪念（日）
...
21. social **[ˈsəʊʃ(ə)l]** `adj` 社会的；社交的
...
22. therefore **[ˈðeəfɔː(r)]** `adv` 因此，所以
...
24. moving **[ˈmuːvɪŋ]** `adj` 感人的 `v` （move 的现在分词）
