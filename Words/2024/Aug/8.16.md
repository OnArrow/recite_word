...
4. liquid **[ˈlɪkwɪd]** `adj` 液态的
    ```
    Boil for 20 minutes until the liquid has reduced by half.
    煮沸20分钟直到液体减少到一半
    ```

5. democracy **[dɪˈmɒkrəsi]** `n` 民主，民主精神

6. amazing **[əˈmeɪzɪŋ]** `adj` 了不起的
    ```
...
8. violently **[ˈvaɪələntli]** `adv` 猛烈地
    ```
...
12. murder **[ˈmɜːdə(r)]** `n` 谋杀；凶杀 `v` 谋杀
    ```
