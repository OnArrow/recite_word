...
9. international **[ˌɪntəˈnæʃ(ə)nəl]** `adj` 国际的
    ```
...
11. bodyguard **[ˈbɒdiɡɑːd]** `n` 保镖；贴身保镖
    ```
...
18. mineral **[ˈmɪnərəl]** `n` 矿物质
    ```
    It was more popular than mineral water
    它比矿泉水更受欢迎
    ```

19. fluency **[ˈfluːənsi]** `n` 流利性
    ```
