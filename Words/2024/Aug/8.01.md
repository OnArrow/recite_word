...
8. entrance **[ˈentrəns]** `n` 入口
    ```
    He stood squarely in front of them, blocking the entrance.
    他就对着他们站在那里，挡住了入口
    ```

9. ridden **[ˈrɪdn]** `v` （ride 的过去分词）

10. mine **[maɪn]** `pron` 我的 `n` 矿，矿井
    ```
    The accident happened through no fault of mine.
    发生事故并不是我的过错
    ```

11. worthless **[ˈwɜːθləs]** `adj` 毫无价值的
    ```
    Critics say his painting are worthless.
    批评家们说他的画毫无价值
    ```

12. libra **[ˈliːbrə]** `n` （重量单位）磅

13. advisor **[ədˈvaɪzə]** `n` 顾问；指导教师
    ```
...
17. confident **[ˈkɒnfɪdənt]** `adj` 充满信心的
    ```
...
19. treasure **[ˈtreʒə(r)]** `n` 金银财宝，财宝
    ```
