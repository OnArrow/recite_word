...
1. interval **[ˈɪntəv(ə)l]** `n` 间隔，间隙；区间
    ```
...
13. cushion **[ˈkʊʃ(ə)n]** `n` 垫子，坐垫；缓冲垫 `v` 减轻...的影响
    ```
...
20. validate **[ˈvælɪdeɪt]** `v` 确认...有效；证实；验证
    ```
