...
8. inspector **[ɪnˈspektə(r)]** `n` 探长；检察员
    ```
...
10. advertiser **[ˈædvətaɪzə(r)]** `n` 报幕员；广告商
    ```
    An advertiser can register on the network.
    广告客户可以在网络中注册
    ```

11. smoothly **[ˈsmuːðli]** `adv` 平稳地；顺利地
    ```
...
20. tremendous **[trəˈmendəs]** `adj` 巨大的
    ```
