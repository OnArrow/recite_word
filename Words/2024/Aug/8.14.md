...
8. huge **[hjuːdʒ]** `adj` 巨大的；庞大的
    ```
    The huge iron gate was locked.
    那扇巨大的铁门被锁上了
    ```

9. calm **[kɑːm]** `adj` 镇定的；冷静的
    ```
