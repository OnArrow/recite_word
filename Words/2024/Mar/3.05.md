...
1. built **[bɪlt]** `v` （build 的过去式）

2. woken **[ˈwəʊkən]** `v` （wake 的过去分词）

3. upstream **[ˌʌpˈstriːm]** `n` 上游 `adj` 逆流而上的
    ```
