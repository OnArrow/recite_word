...
2. twin **[twɪn]** `adj` 双胞胎的，孪生的 `n` 双胞胎之一
    ```
    I can't tell one twin from the other
    我分不清双胞胎中谁是谁
    ```

3. unnecessary **[ʌnˈnesəsəri]** `adj` 不必要的
    ```
...
11. courtyard **[ˈkɔːtjɑːd]** `n` 院子，庭院
    ```
...
14. death **[deθ]** `n` 死亡；死神
    ```
    Death doesn't hold any fear for me
    死亡对我来说没什么可怕的
    ```

15. cotton **[ˈkɒtn]** `n` 棉花 `adj` 棉制的
    ```
