...
2. latch **[lætʃ]** `n` 门拴，门闩；门中间那根控制开关的横木
    ```
    The dog pressed his paw on the latch to left himself in.
    那狗用脚爪按住门闩把自己放了进来
    ```

3. aeronautics **[ˌeərəˈnɔːtɪks]** `n` 航空学
    ```
...
5. impatiently **[ɪmˈpeɪʃntli]** `adv` 不耐烦地
    ```
    'He went back to the lab.' Jack exclaimed impatiently.
    “他回实验室了，” 杰克不耐烦地说道
    ```

6. shuttle **[ˈʃʌt(ə)l]** `n` 航天飞机
    ```
...
20. atmosphere **[ˈætməsfɪə(r)]** `n` 气氛，氛围；大气层
    ```
