...
4. aware **[əˈweə(r)]** `adj` 知道的；察觉到的
    ```
    She is aware of her own fallings.
    她了解自己的弱点
    ```

5. totally **[ˈtəʊtəli]** `adv` 完全地
    ```
...
19. mournful **[ˈmɔːnf(ə)l]** `adj` 悲哀的
    ```
