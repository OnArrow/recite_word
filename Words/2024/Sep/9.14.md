...
3. artiste **[ɑːˈtiːst]** `n` 艺人
    ```
    I will pray for you to be a great artist.
    我会为你祈祷，愿你成为一位最棒的艺人
    ```

4. smoothly **[ˈsmuːðli]** `adv` 平稳地；顺利地
    ```
...
13. giant **[ˈdʒaɪənt]** `adj` 巨大的
    ```
    He's a giant of a man.
    他是个巨人
    ```

14. explosive **[ɪkˈspləʊsɪv]** `n` 炸药
    ```
...
16. smooth **[smuːð]** `adj` （表面）光滑的，平坦的
    ```
