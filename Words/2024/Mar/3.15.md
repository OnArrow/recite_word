...
1. appreciate **[əˈpriːʃieɪt]** `v` 欣赏，鉴赏
    ```
...
7. carousel **[ˌkærəˈsel]** `n` 旋转木马；走马灯
    ```
    You'll find your luggage on carousel number three
    你会发现你的行李在3号旋转台上
    ```

8. beyond **[bɪˈjɒnd]** `prep` 超出（范围）；在...较远的另一边
    ```
...
11. mad **[mæd]** `adj` 发疯的 `n` 字幕版
    ```
    You must be mad to risk it
    你去冒这种风险，简直是疯了
    ```

12. several **[ˈsevrəl]** `pron` 几个；数个
    ```
...
14. district **[ˈdɪstrɪkt]** `n` 地区
    ```
    They have had a growing influence on the district
    他们对这个地区的影响越来越大
    ```

15. modern **[ˈmɒd(ə)n]** `adj` 当代风格的；摩登的，时髦的
    ```
...
19. sympathetic **[ˌsɪmpəˈθetɪk]** `adj` 表示同情的；惺惺相惜的
    ```
