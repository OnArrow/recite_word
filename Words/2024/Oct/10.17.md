...
1. profound **[prəˈfaʊnd]** `adj` （影响）深刻的
    ```
...
9. etcetera **[etˈsetərə]** `n` 等等
    ```
    I like to read books, write a articles etcetera.
    我喜欢读书，写文章等等
    ```

10. coach **[kəʊtʃ]** `n` 教练；（火车）普通车厢
    ```
