...
10. mix **[mɪks]** `v` （使）混合；调制 `n` 混音
    ```
    You can't mix business with pleasure.
    你不能把工作和娱乐混在一起
    ```

11. ambition **[æmˈbɪʃ(ə)n]** `n` 雄心，野心；抱负
    ```
