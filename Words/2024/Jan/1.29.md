...
1. constructor **[kənˈstrʌktə(r)]** `n` 构造函数
    ```
    Provide at least one constructor
    至少提供一个构造函数
    ```

2. shallow **[ˈʃæləʊ]** `adj` 浅的
    ```
    They waded the river at a shallow point
    他们在水浅处蹚过河
    ```

3. logic **[ˈlɒdʒɪk]** `n` 逻辑；（做某事的）道理
    ```
...
9. outline **[ˈaʊtlaɪn]** `n` 轮廓
    ```
    Tress soften the outline of the house
    树木使房子的轮廓显得柔和
    ```

10. integer **[ˈɪntɪdʒə(r)]** `n` 整数
    ```
