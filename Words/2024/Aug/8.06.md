...
1. impatiently **[ɪmˈpeɪʃntli]** `adv` 不耐烦地
    ```
...
7. national **[ˈnæʃ(ə)nəl]** `adj` 国家的
    ```
    The building is part of our national heritage.
    这个建筑是我们民族遗产的一部分
    ```

8. habit **[ˈhæbɪt]** `n` 习惯；瘾
    ```
    They also have the irritating habit of interrupting.
    他们也有打断别人这个令人恼火的习惯
    ```

9. latch **[lætʃ]** `n` 门拴，门闩；门中间那根控制开关的横木
    ```
...
11. endeavour **[ɪnˈdevə(r)]** `n` （航天飞机）奋进号；努力
    ```
...
13. faulty **[ˈfɔːlti]** `adj` 有故障的；有错误的
    ```
    Ask for a refund if the goods are faulty.
    商品如有缺陷，可要求退款
    ```

14. expert **[ˈekspɜːt]** `n` 专家
    ```
...
17. telescope **[ˈtelɪskəʊp]** `n` 望远镜
    ```
    The telescope was pointing in the wrong direction.
    望远镜对错了方向
    ```

18. bark **[bɑːk]** `v` 狗叫；吼叫
    ```
