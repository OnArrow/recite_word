...
8. magic **[ˈmædʒɪk]** `n` 魔法，法术 `adj` 神奇的
    ```
...
12. disease **[dɪˈziːz]** `n` 疾病
    ```
    The disease spreads easily.
    这种疾病容易传播
    ```

13. grower **[ˈɡrəʊə(r)]** `n` 种植者
    ```
...
18. vacant **[ˈveɪkənt]** `adj` （地方）空着的；（职位）空缺的
    ```
    There are many vacant seats in the carriage.
    车厢里空得很
    ```

19. formal **[ˈfɔːm(ə)l]** `adj` （语言）正式的，规范的
    ```
    I felt ill at ease in such formal clothes.
    我穿着这样正式的衣服觉得很拘谨
    ```

20. thresh **[θreʃ]** `vt` 打谷；打庄稼
    ```
