...
1. woken **[ˈwəʊkən]** `v` （wake 的过去分词）

2. built **[bɪlt]** `v` （build 的过去式）

3. deprecate **[ˈdeprəkeɪt]** `vt` 反对；否决
    ```
    You should not deprecate your won worth
    你不应该贬低你自己的价值
    ```

4. important **[ɪmˈpɔːt(ə)nt]** `adj` 重要的
    ```
    The important thing is to keep trying
    重要的是要不断尝试
    ```

5. upstream **[ˌʌpˈstriːm]** `n` 上游 `adj` 逆流而上的
    ```
...
16. encode **[ɪnˈkəʊd]** `v` 给（计算机程序）编码

17. deserve **[dɪˈzɜːv]** `v` 值得；应该得到
    ```
    The players deserve a pat on the back
    运动员们值得表扬
    ```

18. won **[wʌn]** `v` （win 的过去式）
