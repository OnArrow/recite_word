...
3. apparently **[əˈpærəntli]** `adv` 明显地
    ```
    He paused, apparently lost in thought.
    他停顿了下来，显然陷入了沉思
    ```

4. unaware **[ˌʌnəˈweə(r)]** `adj` 不知道的；未察觉的
    ```
...
16. brake **[breɪk]** `n` 刹车 `v` 刹车
    ```
    The car in front of me stopped suddenly and I had to brake.
    我前面那辆车突然停了下来，我也只好刹车
    ```

17. jungle **[ˈdʒʌŋɡ(ə)l]** `n` 丛林
    ```
    The adventure begins in the jungle.
    冒险在丛林开始
    ```

18. matador **[ˈmætədɔː(r)]** `n` 斗牛士
    ```
...
21. mournful **[ˈmɔːnf(ə)l]** `adj` 悲哀的
    ```
