...
4. horsepower **[ˈhɔːspaʊə(r)]** `n` （功率单位）马力
    ```
...
9. sympathetically **[ˌsɪmpəˈθetɪkli]** `adv` 同情地
    ```
...
15. truant **[ˈtruːənt]** `n` 旷课的孩子，逃学的孩子 `v` 旷课，逃学
    ```
    How dared you truant!
    你竟敢逃学！
    ```

16. sensitive **[ˈsensətɪv]** `adj` 过敏的;敏感的
    ```
