...
5. shoulder **[ˈʃəʊldə(r)]** `n` 肩膀
    ```
    The arrow pierced his shoulder.
    箭头射入了他的肩膀。
    ```

6. rifle **[ˈraɪf(ə)l]** `n` 步枪
    ```
...
10. delighted **[dɪˈlaɪtɪd]** `adj` 欣喜的；高兴的
    ```
...
15. profit **[ˈprɒfɪt]** `n` 利润
    ```
    What level of profit do you envisage?
    你预计会有什么样的利润水平？
    ```

16. satisfaction **[ˌsætɪsˈfækʃ(ə)n]** `n` 满意，称心
    ```
    It gave me a feeling of satisfaction.
    它给了我一种满足感。
    ```

17. rapidly **[ˈræpɪdli]** `adv` 迅速地
    ```
...
20. machinery **[məˈʃiːnəri]** `n` 机器，机械（尤指大型机械）
    ```
