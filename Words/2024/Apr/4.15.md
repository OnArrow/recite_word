...
7. rung **[rʌŋ]** `v` （ring 的过去分词）

8. shell **[ʃel]** `n` （蛋、某些动物的）壳；骨架
    ```
    The animal retracted into its shell
    这只动物缩回自己的壳里
    ```

9. occupied **[ˈɒkjupaɪd]** `adj` 忙于...的；（床、椅子、房间等）已被占用的；（地方）被占领的
    ```
...
12. ashtray **[ˈæʃtreɪ]** `n` 烟灰缸
    ```
    Drop your cigarette ashes into the ashtray
    请把香烟灰弹在烟灰缸里
    ```

13. lord **[lɔːd]** `n` 上帝；主，主人；领主，庄园主
    ```
...
21. billion **[ˈbɪljən]** `n` 十亿
    ```
    Imports totalled $1.5 billion last year
    去年的进口总额达15亿美元
    ```

22. attractive **[əˈtræktɪv]** `adj` 吸引人的
    ```
    She's a very attractive woman
    她是个非常迷人的女子
    ```

23. rescue **[ˈreskjuː]** `v` 营救，援救 `n` 营救
    ```
