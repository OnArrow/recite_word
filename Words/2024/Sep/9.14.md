...
11. giant **[ˈdʒaɪənt]** `adj` 巨大的
    ```
    He's a giant of a man.
    他是个巨人
    ```

12. smoothly **[ˈsmuːðli]** `adv` 平稳地；顺利地
    ```
...
14. smooth **[smuːð]** `adj` （表面）光滑的，平坦的
    ```
    The plane made a smooth landing.
    飞机平稳降落
    ```

15. advertiser **[ˈædvətaɪzə(r)]** `n` 报幕员；广告商
    ```
