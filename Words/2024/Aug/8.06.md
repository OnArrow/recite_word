...
1. vicar **[ˈvɪkə(r)]** `n` 牧师
    ```
    The vicar gave an excellent sermon.
    牧师的步道非常精彩
    ```

2. NASA **[ˈnæsə]** `abbr` 美国国家航空和宇宙航行局

3. national **[ˈnæʃ(ə)nəl]** `adj` 国家的
    ```
...
7. endeavour **[ɪnˈdevə(r)]** `n` （航天飞机）奋进号；努力
    ```
...
17. Hubble **[ˈhʌbl]** `n` 哈勃

18. latch **[lætʃ]** `n` 门拴，门闩；门中间那根控制开关的横木
    ```
