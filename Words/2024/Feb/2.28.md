...
2. affixes **[əˈfɪksɪz]** `n` 词缀
    ```
    The affixes of adjectives are large and diverse
    形容词的词缀大且多样
    ```

3. frighten **[ˈfraɪt(ə)n]** `v` （使）惊吓，（使）惊恐
    ```
...
12. countdown **[ˈkaʊntdaʊn]** `n` 倒计时
    ```
    The countdown has begun
    倒计时已经开始
    ```

13. rare **[reə(r)]** `adj` 三分熟；罕见的，不常发生的
    ```
    I specifically asked for this steak rare
    我明确要求把这份牛排做成三分熟
    ```

14. overlap **[ˌəʊvəˈlæp]** `v` 与...重叠 `n` 重叠
    ```
