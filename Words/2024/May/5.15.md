...
3. helpful **[ˈhelpf(ə)l]** `adj` 乐于助人的；有用的
    ```
...
9. extraordinary **[ɪkˈstrɔːd(ə)n(ə)ri]** `adj` 异乎寻常的
    ```
...
15. punctual **[ˈpʌŋktʃuəl]** `adj` 准时的
    ```
...
17. upon **[əˈpɒn]** `prep` 在...上（和 `on` 一致）
    ```
    He set the tray upon the table
    他把盘子放在桌子上
    ```

18. dashboard **[ˈdæʃbɔːd]** `n` 仪表盘
    ```
