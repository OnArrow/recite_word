...
2. numerous **[ˈnjuːmərəs]** `adj` 众多的，许多的
    ```
    He has been late on numerous occasions.
    他已经迟到过无数次了
    ```

3. burst **[bɜːst]** `v` 爆裂，爆炸；胀开
    ```
...
6. annoying **[əˈnɔɪɪŋ]** `adj` 令人恼火的
    ```
    He swatted a fly that was annoying him.
    他猛力拍打一只让他恼火的苍蝇
    ```

7. battle **[ˈbæt(ə)l]** `v` 争吵；与...作战 `n` 战争
    ```
    A much bigger battle is ahead for the president.
    总统还将面临一场更大的战斗
    ```

8. bother **[ˈbɒðə(r)]** `v` （使）烦恼；打扰
    ```
...
18. batter **[ˈbætə(r)]** `v` 殴打；连续猛打；严重破坏
    ```
