...
1. ventilation **[ˌventɪˈleɪʃn]** `n` 通风；通风系统
    ```
...
5. tunnel **[ˈtʌn(ə)l]** `n` 隧道
    ```
    He passed down the tunnel.
    他穿过了隧道
    ```

6. admire **[ədˈmaɪə(r)]** `v` 钦佩，仰慕；欣赏
    ```
...
16. officially **[əˈfɪʃəli]** `adv` 正式地；官方地
    ```
    We haven't yet been told officially about the closure.
    我们尚未接到关闭的正式通知
    ```

17. reception **[rɪˈsepʃ(ə)n]** `n` 招待会；接待处
    ```
    You can leave a message with reception.
    你可以在招待处留个口信
    ```

18. chimney **[ˈtʃɪmni]** `n` 烟囱
    ```
...
20. enthusiast **[ɪnˈθjuːziæst]** `n` 爱好者
    ```
