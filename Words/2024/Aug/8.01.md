...
4. worthless **[ˈwɜːθləs]** `adj` 毫无价值的
    ```
    Critics say his painting are worthless.
    批评家们说他的画毫无价值
    ```

5. mine **[maɪn]** `pron` 我的 `n` 矿，矿井
    ```
    The accident happened through no fault of mine.
    发生事故并不是我的过错
    ```

6. trunk **[trʌŋk]** `n` （汽车）后备箱；箱子；树干
    ```
...
8. pirate **[ˈpaɪrət]** `n` 海盗
    ```
    I always feel like a pirate.
    我总觉得自己像个海盗
    ```

9. led **[led]** `v` （lead 的过去式）
...
11. treasure **[ˈtreʒə(r)]** `n` 金银财宝，财宝
    ```
