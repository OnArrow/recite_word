...
2. pornographic **[ˌpɔːnəˈɡræfɪk]** `adj` 色情的
    ```
...
4. unsigned **[ˌʌnˈsaɪnd]** `adj` 未签名的；无符号的
    ```
...
7. distinct **[dɪˈstɪŋkt]** `adj` 不同的，有区别的
    ```
    It has a very distinct flavor.
    它有一种非常独特的味道
    ```

8. scientist **[ˈsaɪəntɪst]** `n` 科学家
    ```
...
11. abnormal **[æbˈnɔːm(ə)l]** `adj` 不规则的；反常的
    ```
...
15. ascending **[əˈsendɪŋ]** `adj` 升序的，上升的

16. biography **[baɪˈɒɡrəfi]** `n` 传记；生平
    ```
    She agreed to collaborate with him to writing her biography.
    她同意与他合作撰写她的传记
    ```

17. curious **[ˈkjʊəriəs]** `adj` 好奇的
    ```
    'I'm not meddling,' Jack said mildly, 'I'm just curious.'
    “我不是在管闲事，” 肯温和地说，“我只是好奇”
    ```

18. republic **[rɪˈpʌblɪk]** `n` 共和国
    ```
    In 1918, Austria became a republic.
    1918年，奥地利成为共和国
    ```

19. truncate **[trʌŋˈkeɪt]** `v` 截断，删节

20. varchar **[ˈvɑːtʃɑː]** `n` 文本类型；可变长字符串
