...
2. violent **[ˈvaɪələnt]** `adj` 暴力的；剧烈的
    ```
    I disagree with violent protests.
    我不赞成暴力抗议
    ```

3. survivor **[səˈvaɪvə(r)]** `n` 幸存者
    ```
...
9. macaroni **[ˌmækəˈrəʊni]** `n` 空心面
    ```
    What do you mean by macaroni?
    你说的空心面指的是什么?
    ```

10. announcer **[əˈnaʊnsə(r)]** `n` 播音员
    ```
...
19. surely **[ˈʃʊəli]** `adv` （用于表明你相信某事极有可能）想必
    ```
