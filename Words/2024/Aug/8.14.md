...
4. altogether **[ˌɔːltəˈɡeðə(r)]** `adv` 总共
    ```
...
10. award **[əˈwɔːd]** `v` 授予 `n` 奖
    ```
    He was nominated for the best actor award.
    他获得最佳演员提名
    ```

11. elegant **[ˈelɪɡənt]** `adj` 举止优雅的
    ```
