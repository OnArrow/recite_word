...
6. necessary **[ˈnesəsəri]** `adj` 必要的，必需的
    ```
...
11. unnecessary **[ʌnˈnesəsəri]** `adj` 不必要的
    ```
    I hate unnecessary waste
    我憎恨不必要的浪费
    ```

12. append **[əˈpend]** `v` 追加
    ```
...
15. confine **[kənˈfaɪn]** `v` 关押，监禁；局限
    ```
...
18. meanwhile **[ˈmiːnwaɪl]** `adv` 与此同时，同时
    ```
