...
8. agreement **[əˈɡriːmənt]** `n` 协议；契约
    ```
...
11. election **[ɪˈlekʃ(ə)n]** `n` 选举；当选
    ```
    How did you vote at the last election?
    在上次选举中你是怎么投的票？
    ```

12. coincidence **[kəʊˈɪnsɪdəns]** `n` 巧合
    ```
...
16. defeat **[dɪˈfiːt]** `v` 击败 `n` 战败
    ```
    Don't let this defeat dishearten you.
    不要因这次失败而气馁
    ```

17. encouragement **[ɪnˈkʌrɪdʒmənt]** `n` 鼓励
    ```
    She was given every encouragement to try something new.
    她得到充分的鼓励去尝试新事物
    ```

18. gratitude **[ˈɡrætɪtjuːd]** `n` 感谢
    ```
