...
2. union **[ˈjuːniən]** `n` 联邦；联合

3. babysit **[ˈbeɪbisɪt]** `v` 临时照看婴儿
    ```
    Could you babysit for us on Friday?
    周五你能帮我们照看下孩子吗？
    ```

4. override **[ˌəʊvəˈraɪd]** `v` 覆盖；重写
    ```
    You can override this behavior
    你可以重写该行为
    ```

5. slain **[sleɪn]** `v` （slay 的过去分词）

6. plain **[pleɪn]** `adj` 朴素的，无装饰的
    ```
    The walls were plain and unadorned
    墙壁朴实无华
    ```

7. slew **[sluː]** `v` （slay 的过去式）
...
10. bodyguard **[ˈbɒdiɡɑːd]** `n` 保镖；贴身保镖
    ```
...
12. coca **[ˈkəʊkə]** `n` 古柯叶
    ```
    I bought him a Coca-Cola
    我给他买了一瓶可口可乐
    ```

13. soda **[ˈsəʊdə]** `n` 苏打；碳酸水
    ```
...
15. reflect **[rɪˈflekt]** `v` 反射（光、热）；引起（某种）看法
    ```
...
18. participate **[pɑːˈtɪsɪpeɪt]** `v` 参加，参与
    ```
    Over half the population of this country participate the sports
    这个国家超过半数的人参与体育运动
    ```

19. external **[ɪkˈstɜːn(ə)l]** `adj` 外部的
    ```
