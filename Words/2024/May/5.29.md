...
1. meanwhile **[ˈmiːnwaɪl]** `adv` 与此同时，同时
    ```
...
8. anymore **[ˌeniˈmɔː(r)]** `adv` 不再
    ```
    I don't trust my father anymore
    我再也不相信我父亲了
    ```

9. feet **[fiːt]** `n` （foot 的复数）

10. twin **[twɪn]** `adj` 双胞胎的，孪生的 `n` 双胞胎之一
    ```
    I can't tell one twin from the other
    我分不清双胞胎中谁是谁
    ```

11. bother **[ˈbɒðə(r)]** `v` （使）担心
    ```
    I don't want to bother her with my problems at the moment
    我此刻不想让他为我的事操心
    ```

12. haunt **[hɔːnt]** `v` （鬼魂）出没，闹鬼
    ```
    People say ghosts haunt that old house
    据说那座老宅子有鬼魂出没
    ```

13. shook **[ʃʊk]** `v` （shake 的过去式）

14. necessary **[ˈnesəsəri]** `adj` 必要的，必需的
    ```
    If necessary I can come at once
    如果有必要，我可以马上来
    ```

15. admit **[ədˈmɪt]** `v` （勉强）承认
    ```
...
18. shaken **[ˈʃeɪkən]** `v` （shake 的过去式）
