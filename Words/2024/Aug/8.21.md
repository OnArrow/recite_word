...
1. truant **[ˈtruːənt]** `n` 旷课的孩子，逃学的孩子 `v` 旷课，逃学
    ```
    How dared you truant!
    你竟敢逃学！
    ```

2. clumsily **[ˈklʌmzɪli]** `adv` 笨拙地
    ```
...
6. horsepower **[ˈhɔːspaʊə(r)]** `n` （功率单位）马力
    ```
...
10. footstep **[ˈfʊtstep]** `n` 脚步，足迹
    ```
    It's hard to follow on her footstep.
    追寻她的足迹很困难
    ```

11. sensitive **[ˈsensətɪv]** `adj` 过敏的;敏感的
    ```
...
13. parliament **[ˈpɑːləmənt]** `n` 议会；国会
    ```
...
15. meantime **[ˈmiːntaɪm]** `n` 其间；同时 `adv` 在此期间
    ```
    I'll contact them soon. Meantime don't tell them I'm back.
    我会尽快和他们联系，在此期间不要跟他们说我回来了
    ```

16. unimaginative **[ˌʌnɪˈmædʒɪnətɪv]** `adj` 缺乏想象力的
    ```
    He's an unimaginative teacher.
    他是个缺乏想象力的老师
    ```

17. observatory **[əbˈzɜːvətri]** `n` 天文台；气象台
    ```
