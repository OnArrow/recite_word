...
2. biography **[baɪˈɒɡrəfi]** `n` 传记；生平
    ```
...
4. ascending **[əˈsendɪŋ]** `adj` 升序的，上升的
...
8. pornographic **[ˌpɔːnəˈɡræfɪk]** `adj` 色情的
    ```
