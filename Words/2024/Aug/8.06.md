...
5. atmosphere **[ˈætməsfɪə(r)]** `n` 大气层
    ```
...
13. telescope **[ˈtelɪskəʊp]** `n` 望远镜
    ```
    The telescope was pointing in the wrong direction.
    望远镜对错了方向
    ```

14. teller **[telə(r)]** `n` （银行）出纳员
    ```
    You become a mind reader and a fortune teller.
    你变成了一个揣摩别人心思的人，算命先生
    ```

15. national **[ˈnæʃ(ə)nəl]** `adj` 国家的
    ```
    The building is part of our national heritage.
    这个建筑是我们民族遗产的一部分
    ```

16. shuttle **[ˈʃʌt(ə)l]** `n` 航天飞机
    ```
...
19. Endeavour **[ɪnˈdevə(r)]** `n` （航天飞机）奋进号
