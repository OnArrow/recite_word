...
1. obviously **[ˈɒbviəsli]** `adv` （用于强调）显然
    ```
...
10. monster **[ˈmɒnstə(r)]** `n` 怪物，怪兽
    ```
    He drew a monster and color it green
    他画了一个怪物，把它涂成绿色
    ```

11. telegram **[ˈtelɪɡræm]** `n` 电报
    ```
