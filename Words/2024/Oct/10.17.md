...
1. posture **[ˈpɒstʃə(r)]** `n` 立场，态度；（坐或立的）姿势
    ```
...
4. profitably **[ˈprɒfɪtəbli]** `adv` 有益地
    ```
...
6. compel **[kəmˈpel]** `v` 强迫
    ```
    Nothing can compel me to do such a thing.
    没有什么可以强迫我做这件事
    ```

7. convince **[kənˈvɪns]** `v` 使确信；说服
    ```
...
9. behavior **[bɪˈheɪvjə(r)]** `n` 行为
    ```
    It is an uncontrollable behavior.
    这是一种无法控制的行为
    ```

10. kindergarten **[ˈkɪndəɡɑːt(ə)n]** `n` 幼儿园
    ```
