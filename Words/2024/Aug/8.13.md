...
2. fortunate **[ˈfɔːtʃənət]** `adj` 幸运的
    ```
...
8. reception **[rɪˈsepʃ(ə)n]** `n` 招待会；接待处
    ```
    You can leave a message with reception.
    你可以在招待处留个口信
    ```

9. bomber **[ˈbɒmə(r)]** `n` 轰炸机
    ```
...
11. enthusiast **[ɪnˈθjuːziæst]** `n` 爱好者
    ```
    He is a great sports enthusiast.
    他是个真正的体育爱好者
    ```

12. ventilate **[ˈventɪleɪt]** `v` 使通风
    ```
...
19. admire **[ədˈmaɪə(r)]** `v` 钦佩，仰慕；欣赏
    ```
