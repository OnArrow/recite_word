...
1. eventually **[ɪˈventʃuəli]** `adv` 最终
    ```
...
6. copper **[ˈkɒpə(r)]** `n` 铜
    ```
    What is the chemical symbol for copper?
    铜的化学符号是什么？
    ```

7. fantasy **[ˈfæntəsi]** `n` 幻想，幻想故事
    ```
...
9. reluctant **[rɪˈlʌktənt]** `adj` 勉强的，不情愿的
    ```
...
13. definitely **[ˈdefɪnətli]** `adv` 肯定地
    ```
    Do you know what I definitely believe in?
    你知道什么是我绝对相信的吗？
    ```

14. ambassador **[æmˈbæsədə(r)]** `n` 大使
    ```
...
18. pedestal **[ˈpedɪst(ə)l]** `n` 底座
    ```
    The statue fell off from the pedestal.
    雕像从底座上掉了下来
    ```

19. lantern **[ˈlæntən]** `n` 灯笼
    ```
