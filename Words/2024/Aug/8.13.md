...
3. invasion **[ɪnˈveɪʒ(ə)n]** `n` 侵略；入侵
    ```
...
6. rediscover **[ˌriːdɪˈskʌvə(r)]** `vt` 重新发现
    ```
...
12. accompany **[əˈkʌmpəni]** `v` 陪伴，伴随
    ```
...
16. reception **[rɪˈsepʃ(ə)n]** `n` 招待会；接待处
    ```
