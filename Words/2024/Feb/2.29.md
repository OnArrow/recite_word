...
15. publish **[ˈpʌblɪʃ]** `v` 出版；发布
    ```
    We publish about 35 letters each week
    我们每周大约发表35封信封
    ```

16. exclude **[ɪkˈskluːd]** `vt` 把...排除在外
    ```
...
20. paragraph **[ˈpærəɡrɑːf]** `n` （文章）段落
    ```
