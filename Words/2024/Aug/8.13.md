...
11. Pacific **[pəˈsɪfɪk]** `n` 太平洋
    ```
    They spent many days cruising the northern Pacific Ocean.
    他们花了很多天巡游北太平洋
    ```

12. officially **[əˈfɪʃəli]** `adv` 正式地；官方地
    ```
...
14. tunnel **[ˈtʌn(ə)l]** `n` 隧道
    ```
    He passed down the tunnel.
    他穿过了隧道
    ```

15. ought **[ɔːt]** `v` 应该（表义务、责任、必要等）
    ```
...
17. fortunate **[ˈfɔːtʃənət]** `adj` 幸运的
    ```
