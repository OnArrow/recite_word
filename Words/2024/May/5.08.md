...
1. honest **[ˈɒnɪst]** `adj` 诚实的
    ```
    I know she's honest and reliable
    我相信她是诚实可靠的
    ```

2. exchange **[ɪksˈtʃeɪndʒ]** `n` 电话交换台，电话局
...
9. continually **[kənˈtɪnjuəli]** `adv` 不断地；连续地
    ```
    New products are continually being developed
    新产品正源源不断地开发出来
    ```

10. despair **[dɪˈspeə(r)]** `n` 绝望
    ```
...
13. unsmiling **[ˌʌnˈsmaɪlɪŋ]** `adj` 严肃的；不笑的
    ```
...
19. sunshine **[ˈsʌnʃaɪn]** `n` 阳光
    ```
    This room gets very little sunshine
    这个房间几乎照不进阳光
    ```

20. immense **[ɪˈmens]** `adj` 巨大的
    ```
