...
3. luckily **[ˈlʌkɪli]** `adv` 幸好，幸运地
    ```
    Luckily I was at home when he called
    他来看我时,我幸好在家
    ```

4. percent **[pəˈsent]** `n` 百分之...
    ```
    Drug stores upped sales by 63 percent
    药店的销售额增加了63%
    ```

5. woollen **[ˈwʊlən]** `adj` (同 woolen)

6. penguin **[ˈpeŋɡwɪn]** `n` 企鹅
    ```
...
11. smelt **[smelt]** `v` (smell 的过去式)
    ```
    The dog has smelt the rabbit
    狗嗅到了兔子的气味
    ```

12. stuck **[stʌk]** `adj` 卡住的，动不了的 `v` （stick 的过去式）
    ```
