...
4. wheel **[wiːl]** `n` 轮子，车轮
    ```
    The wheel is pulling to the left
    方向盘正在向左打
    ```

5. comb **[kəʊm]** `v` 梳理 `n` 梳子；发卡
    ```
...
7. sanitize **[ˈsænɪtaɪz]** `vt` 给...消毒；对...采取卫生措施
    ```
...
12. novel **[ˈnɒv(ə)l]** `n` （长篇）小说
    ```
    Have you read her new novel?
    你看过她新出的小说了吗？
    ```

13. celsius **[ˈselsiəs]** `n` 摄氏度
    ```
...
17. classical **[ˈklæsɪk(ə)l]** `adj` 经典的，传统的；古典的
    ```
...
19. vegetarian **[ˌvedʒəˈteəriən]** `n` 素食者；素食主义者
    ```
