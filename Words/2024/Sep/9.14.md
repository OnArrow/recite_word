...
6. swung **[swʌŋ]** `v` （swing 的过去式）

7. overfish **[ˌəʊvəˈfɪʃ]** `v` 过度捕捞
    ```
...
15. speedboat **[ˈspiːdbəʊt]** `n` 快艇
    ```
    The speedboat had struck a buoy.
    快艇撞上了一个浮标
    ```

16. inspector **[ɪnˈspektə(r)]** `n` 探长；检察员
    ```
    This ruling applies to the ranks of inspector and below.
    这项规定适用于检察员及以下人员
    ```

17. smooth **[smuːð]** `adj` （表面）光滑的，平坦的
    ```
