...
1. eager **[ˈiːɡə(r)]** `adj` 热情的；热切的；渴望的
    ```
...
18. granted **[ˈɡrɑːntɪd]** `v` （grant 的过去式） `adv` 的确；想当然
    ```
...
20. excitement **[ɪkˈsaɪtmənt]** `n` 令人激动的事；兴奋
    ```
