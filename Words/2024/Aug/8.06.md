...
2. endeavour **[ɪnˈdevə(r)]** `n` （航天飞机）奋进号；努力
    ```
...
4. impatiently **[ɪmˈpeɪʃntli]** `adv` 不耐烦地
    ```
...
9. atmosphere **[ˈætməsfɪə(r)]** `n` 气氛，氛围；大气层
    ```
    The atmosphere of Mars could not support life.
    生命无法在火星的大气层内生存
    ```

10. national **[ˈnæʃ(ə)nəl]** `adj` 国家的
    ```
...
14. faulty **[ˈfɔːlti]** `adj` 有故障的；有错误的
    ```
...
18. NASA **[ˈnæsə]** `abbr` 美国国家航空和宇宙航行局

19. latch **[lætʃ]** `n` 门拴，门闩；门中间那根控制开关的横木
    ```
    The dog pressed his paw on the latch to left himself in.
    那狗用脚爪按住门闩把自己放了进来
    ```

20. teller **[telə(r)]** `n` （银行）出纳员；讲述者，讲故事的人
    ```
