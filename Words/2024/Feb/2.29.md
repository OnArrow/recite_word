...
8. exclude **[ɪkˈskluːd]** `vt` 把...排除在外
    ```
    You can exclude projects from this process if you wish
    如果需要，可以将项目排除在这个过程之外
    ```

9. even **[ˈiːv(ə)n]** `adv` 甚至，即使；更加，愈加
    ```
...
15. bistro **[ˈbiːstrəʊ]** `n` 小酒馆
    ```
    We ate in the restaurant, as opposed to the bistro
    我们是在饭店吃的饭，而不是在小酒馆
    ```

16. independent **[ˌɪndɪˈpendənt]** `adj` 独立的，自治的；有主见的
    ```
...
18. paragraph **[ˈpærəɡrɑːf]** `n` （文章）段落
    ```
    As a news item it merits a short paragraph at most
    作为一则新闻，它至多只能占一小段
    ```

19. lately **[ˈleɪtli]** `adv` 最近
    ```
    She's been very edgy lately
    她最近一直烦躁不安
    ```

20. trade **[treɪd]** `n` 贸易；营业额；交易 `v` 做生意；交易
    ```
