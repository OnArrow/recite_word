...
1. flood **[flʌd]** `n` 洪水，火灾
    ```
    The flood was too deep to drive through.
    洪水太深，汽车开不过去
    ```

2. spray **[spreɪ]** `v` 喷洒，喷射；喷农药
    ```
...
11. surrounding **[səˈraʊndɪŋ]** `adj` 周围的，周边的
    ```
...
13. destruction **[dɪˈstrʌkʃ(ə)n]** `n` 破坏，毁灭
    ```
