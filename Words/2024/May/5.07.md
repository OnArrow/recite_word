...
1. fantastic **[fænˈtæstɪk]** `adj` 极好的，非常棒的
    ```
    Fantastic! The real English breakfast
    太棒了！这就是真正的英式早餐
    ```

2. outstanding **[aʊtˈstændɪŋ]** `adj` 杰出的，优秀的
    ```
...
18. then **[ðen]** `adv` （指过去）当时；然后
    ```
    Watch what I do, then you try
    你注意看我的动作，然后试着做
    ```

19. dull **[dʌl]** `adj` 枯燥无聊的
    ```
    The party was stupefyingly dull
    这次聚会无聊透了
    ```

20. chunk **[tʃʌŋk]** `n` 数据块；块
    ```
