...
8. woke **[wəʊk]** `v` （wake 的过去式）

9. occasion **[əˈkeɪʒ(ə)n]** `n` 场合
    ```
...
13. captain **[ˈkæptɪn]** `n` 队长；首领
    ```
    The captain was at the other end of the room
    队长在房间的另一头
    ```

14. won **[wʌn]** `v` （win 的过去式）
...
16. pop **[pɒp]** `adj` 流行音乐的 `n` 流行音乐
    ```
    Pop stars are always news
    流行音乐明星总是新闻人物
    ```

17. woken **[ˈwəʊkən]** `v` （wake 的过去分词）
