...
2. external **[ɪkˈstɜːn(ə)l]** `adj` 外部的
    ```
...
7. accuracy **[ˈækjərəsi]** `n` 准确性
    ```
    She hits the ball with great accuracy
    她击球十分准确
    ```

8. flour **[ˈflaʊə(r)]** `n` 面粉
    ```
...
20. international **[ˌɪntəˈnæʃ(ə)nəl]** `adj` 国际的
    ```
    We have a number of international player in our ranks
    我们的队员中有好几个国际选手
    ```

21. slew **[sluː]** `v` （slay 的过去式）
