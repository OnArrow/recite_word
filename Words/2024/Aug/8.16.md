...
8. murder **[ˈmɜːdə(r)]** `n` 谋杀；凶杀 `v` 谋杀
    ```
    The story opens with a murder.
    这个故事以谋杀案开始
    ```

9. violently **[ˈvaɪələntli]** `adv` 猛烈地
    ```
...
14. unbelievable **[ˌʌnbɪˈliːvəb(ə)l]** `adj` 难以置信的
    ```
...
19. democracy **[dɪˈmɒkrəsi]** `n` 民主，民主精神

20. persistent **[pəˈsɪstənt]** `adj` 固执的，执着的
    ```
