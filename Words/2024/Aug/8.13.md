...
1. invasion **[ɪnˈveɪʒ(ə)n]** `n` 侵略；入侵
    ```
...
10. tunnel **[ˈtʌn(ə)l]** `n` 隧道
    ```
    He passed down the tunnel.
    他穿过了隧道
    ```

11. rediscover **[ˌriːdɪˈskʌvə(r)]** `vt` 重新发现
    ```
...
13. continent **[ˈkɒntɪnənt]** `n` 洲；大陆
    ```
    He traversed alone the whole continent of Africa from east to west.
    他独自一人从东到西横越整个非洲大陆
    ```

14. enthusiast **[ɪnˈθjuːziæst]** `n` 热心人；爱好者
    ```
...
18. ventilation **[ˌventɪˈleɪʃn]** `n` 通风；通风系统
    ```
