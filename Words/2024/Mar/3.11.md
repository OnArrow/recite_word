...
3. reflect **[rɪˈflekt]** `v` 反射（光、热）；引起（某种）看法
    ```
...
13. override **[ˌəʊvəˈraɪd]** `v` 覆盖；重写
    ```
    You can override this behavior
    你可以重写该行为
    ```

14. babysit **[ˈbeɪbisɪt]** `v` 临时照看婴儿
    ```
...
18. bodyguard **[ˈbɒdiɡɑːd]** `n` 保镖；贴身保镖
    ```
