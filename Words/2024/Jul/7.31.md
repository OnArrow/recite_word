...
16. clothing **[ˈkləʊðɪŋ]** `n` 衣服
    ```
    His clothing was stained with mud.
    他的衣服沾了泥
    ```

17. numerous **[ˈnjuːmərəs]** `adj` 众多的，许多的
    ```
