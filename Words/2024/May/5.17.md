...
9. anxious **[ˈæŋkʃəs]** `adj` 焦虑的，担心的；紧张的
    ```
    We grew more anxious with every passing day
    我们每过一天就增多一份焦虑
    ```

10. difference **[ˈdɪfrəns]** `n` 差异；区别
    ```
...
17. India **[ˈɪndiə]** `n` 印度
    ```
    The tiger is native to India
    这种虎产于印度
    ```

18. Indian **[ˈɪndiən]** `n` 印度人 `adj` 印度的
    ```
