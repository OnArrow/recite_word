...
1. fortunate **[ˈfɔːtʃənət]** `adj` 幸运的
    ```
...
4. invasion **[ɪnˈveɪʒ(ə)n]** `n` 侵略；入侵
    ```
...
15. officially **[əˈfɪʃəli]** `adv` 正式地；官方地
    ```
...
18. reception **[rɪˈsepʃ(ə)n]** `n` 招待会；接待处
    ```
