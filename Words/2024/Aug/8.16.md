...
2. democracy **[dɪˈmɒkrəsi]** `n` 民主，民主精神
...
4. instruct **[ɪnˈstrʌkt]** `v` 指示，吩咐；指导
    ```
...
8. persistent **[pəˈsɪstənt]** `adj` 固执的，执着的
    ```
    I had a persistent cough for over a month.
    我持续咳嗽已经一个月了
    ```

9. amazing **[əˈmeɪzɪŋ]** `adj` 了不起的
    ```
...
12. erupt **[ɪˈrʌpt]** `v` 喷发；爆发
    ```
    The volcano could erupt at any time.
    这座火山随时可能爆发
    ```

13. insist **[ɪnˈsɪst]** `v` 坚持要求；坚持做
    ```
    We insist on the highest standards at all times.
    我们始终坚持最高标准
    ```

14. murder **[ˈmɜːdə(r)]** `n` 谋杀；凶杀 `v` 谋杀
    ```
