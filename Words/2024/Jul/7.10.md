...
2. distinct **[dɪˈstɪŋkt]** `adj` 不同的，有区别的
    ```
...
5. ascending **[əˈsendɪŋ]** `adj` 升序的，上升的
...
7. descending **[dɪˈsendɪŋ]** `adj` 降序的，递降的

8. biography **[baɪˈɒɡrəfi]** `n` 传记；生平
    ```
    She agreed to collaborate with him to writing her biography.
    她同意与他合作撰写她的传记
    ```

9. alter **[ˈɔːltə(r)]** `v` 改变，改动
    ```
...
13. tiny **[ˈtaɪni]** `adj` 极小的，微小的
    ```
    Her tiny hands gently touched my face.
    她的小手轻轻触摸着我的脸
    ```

14. abnormal **[æbˈnɔːm(ə)l]** `adj` 不规则的；反常的
    ```
    They thought his behavior was abnormal.
    他们认为他行为反常
    ```

15. grip **[ɡrɪp]** `v` 握紧，夹住
    ```
    Grip the rope as tightly as you can.
    尽可能地紧紧抓住绳子
    ```

16. stupidity **[stjuːˈpɪdəti]** `n` 愚蠢；愚蠢想法
    ```
    She wondered at her own stupidity.
    她没想到自己会这样愚蠢
    ```

17. conclusion **[kənˈkluːʒn]** `n` 结论
    ```
...
20. pornographic **[ˌpɔːnəˈɡræfɪk]** `adj` 色情的
    ```
