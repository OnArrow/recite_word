...
4. nervous **[ˈnɜːvəs]** `adj` 神经紧张的，紧张不安的
    ```
...
11. mistaken **[mɪˈsteɪkən]** `adj` （想法、观点）不正确的 `v` （mistake 的过去分词）
    ```
