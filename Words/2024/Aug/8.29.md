...
1. temper **[ˈtempə(r)]** `n` 坏脾气
    ```
    He needs to learn to curb his temper.
    他得学着控制自己的脾气。
    ```

2. satisfaction **[ˌsætɪsˈfækʃ(ə)n]** `n` 满意，称心
    ```
...
14. salute **[səˈluːt]** `v` （向...）行礼
    ```
    Before starting your performance, salute your audience!
    在你开始表演之前，向你的观众行礼
    ```

15. delighted **[dɪˈlaɪtɪd]** `adj` 欣喜的；高兴的
    ```
    I'm delighted at your news.
    听到你的消息我很高兴
    ```

16. machinery **[məˈʃiːnəri]** `n` 机器，机械（尤指大型机械）
    ```
...
18. prisoner **[ˈprɪz(ə)nə(r)]** `n` 囚犯

19. profit **[ˈprɒfɪt]** `n` 利润
    ```
