...
1. certain **[sɜːt(ə)n]** `adj` 某个；无疑的
    ```
    Some students are exempt from certain exams
    有的学生可免除某些考试
    ```

2. Olympic **[əˈlɪmpɪk]** `adj` 奥林匹克运动会的
    ```
...
10. exchange **[ɪksˈtʃeɪndʒ]** `n` 电话交换台，电话局
...
12. unsmiling **[ˌʌnˈsmaɪlɪŋ]** `adj` 严肃的；不笑的
    ```
...
16. continually **[kənˈtɪnjuəli]** `adv` 不断地；连续地
    ```
