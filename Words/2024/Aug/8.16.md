...
2. confidence **[ˈkɒnfɪdəns]** `n` 信心
    ```
    Confidence is the key to success.
    信心是成功的关键
    ```

3. unless **[ənˈles]** `conj` 除非
    ```
    Have a cup of tea, unless you'd prefer a cold drink.
    喝杯茶吧，除非你喜欢冷饮
    ```

4. erupt **[ɪˈrʌpt]** `v` 喷发；爆发
    ```
...
6. persistent **[pəˈsɪstənt]** `adj` 固执的，执着的
    ```
...
14. violently **[ˈvaɪələntli]** `adv` 猛烈地
    ```
    She had been violently sick.
    她一直吐得很厉害
    ```

15. insist **[ɪnˈsɪst]** `v` 坚持要求；坚持做
    ```
