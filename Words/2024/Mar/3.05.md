...
15. parameter **[pəˈræmɪtə(r)]** `n` 参数
    ```
    How should you actually set this parameter?
    你实际上如何设置这个参数呢？
    ```

16. deserve **[dɪˈzɜːv]** `v` 值得；应该得到
    ```
