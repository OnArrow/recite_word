...
2. stalk **[stɔːk]** `n` （植物的）梗，茎，杆
    ```
    Now the rain pours right down the stalk.
    现在雨水顺着茎秆直下
    ```

3. vacant **[ˈveɪkənt]** `adj` （地方）空着的；（职位）空缺的
    ```
...
8. fancy **[ˈfænsi]** `v` （表示惊奇或震惊）真想不到，竟然
    ```
    Fancy! She's never been in a plane before.
    真想不到!她竟然从未坐过飞机
    ```

9. confess **[kənˈfes]** `v` 承认，坦白
    ```
...
15. mummy **[ˈmʌmi]** `n` 木乃伊
    ```
    The mummy has been buried.
    这木乃伊被填埋了
    ```

16. formal **[ˈfɔːm(ə)l]** `adj` （语言）正式的，规范的
    ```
...
18. survive **[səˈvaɪv]** `v` (经历事故，战争或疾病后)活下来，幸存
    ```
