...
5. aeronautics **[ˌeərəˈnɔːtɪks]** `n` 航空学
    ```
...
8. vicar **[ˈvɪkə(r)]** `n` 牧师
    ```
    The vicar gave an excellent sermon.
    牧师的步道非常精彩
    ```

9. NASA **[ˈnæsə]** `abbr` 美国国家航空和宇宙航行局

10. teller **[telə(r)]** `n` （银行）出纳员；讲述者，讲故事的人
    ```
...
13. atmosphere **[ˈætməsfɪə(r)]** `n` 气氛，氛围；大气层
    ```
    The atmosphere of Mars could not support life.
    生命无法在火星的大气层内生存
    ```

14. habit **[ˈhæbɪt]** `n` 习惯；瘾
    ```
...
17. endeavour **[ɪnˈdevə(r)]** `n` （航天飞机）奋进号；努力
    ```
