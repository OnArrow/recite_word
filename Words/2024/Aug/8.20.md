...
12. British **[ˈbrɪtɪʃ]** `adj` （大不列颠及北爱尔兰）联合王国的
    ```
    We were still in British waters.
    我们仍在英国的领海上
    ```

13. engine **[ˈendʒɪn]** `n` 引擎，发动机
    ```
...
18. aware **[əˈweə(r)]** `adj` 知道的；察觉到的
    ```
    She is aware of her own fallings.
    她了解自己的弱点
    ```

19. brake **[breɪk]** `n` 刹车 `v` 刹车
    ```
    The car in front of me stopped suddenly and I had to brake.
    我前面那辆车突然停了下来，我也只好刹车
    ```

20. unaware **[ˌʌnəˈweə(r)]** `adj` 不知道的；未察觉的
    ```
    She was unaware that I could see her.
    她没想到我能看见她
    ```

21. delight **[dɪˈlaɪt]** `n` 令人高兴的人或事
    ```
