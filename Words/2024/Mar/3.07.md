...
3. rent **[rent]** `n` 租金 `vt` 租用
    ```
    Who do you rent the land from?
    你从谁那里租的地？
    ```

4. landlord **[ˈlændlɔːd]** `n` 房东；店主
    ```
...
10. secretary **[ˈsekrət(ə)ri]** `n` 秘书；书记员
    ```
...
12. gym **[dʒɪm]** `n` 健身房；体育馆
    ```
    I was in the gym lifting weights
    我正在健身房举哑铃
    ```

13. exclaim **[ɪkˈskleɪm]** `v` 大声说；惊叫
    ```
