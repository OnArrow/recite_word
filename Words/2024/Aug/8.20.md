...
4. fought **[fɔːt]** `v` （fight 的过去式）

5. bullfight **[ˈbʊlfaɪt]** `n` 斗牛
    ```
...
18. mournful **[ˈmɔːnf(ə)l]** `adj` 悲哀的
    ```
