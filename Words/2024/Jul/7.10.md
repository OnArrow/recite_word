...
1. species **[ˈspiːʃiːz]** `n` 物种
    ```
    This species is extremely rare.
    这一物种极其罕见
    ```

2. abnormal **[æbˈnɔːm(ə)l]** `adj` 不规则的；反常的
    ```
    They thought his behavior was abnormal.
    他们认为他行为反常
    ```

3. truncate **[trʌŋˈkeɪt]** `v` 截断，删节
...
9. tiny **[ˈtaɪni]** `adj` 极小的，微小的
    ```
    Her tiny hands gently touched my face.
    她的小手轻轻触摸着我的脸
    ```

10. pornographic **[ˌpɔːnəˈɡræfɪk]** `adj` 色情的
    ```
...
12. theory **[ˈθɪəri]** `n` 理论
    ```
    The theory remains untested.
    该理论仍未经过验证
    ```

13. republic **[rɪˈpʌblɪk]** `n` 共和国
    ```
    In 1918, Austria became a republic.
    1918年，奥地利成为共和国
    ```

14. descending **[dɪˈsendɪŋ]** `adj` 降序的，递降的
...
18. ascending **[əˈsendɪŋ]** `adj` 升序的，上升的

19. curious **[ˈkjʊəriəs]** `adj` 好奇的
    ```
