...
5. ventilate **[ˈventɪleɪt]** `v` 使通风
    ```
    Open the window and ventilate the room.
    打开窗户通通风
    ```

6. enthusiast **[ɪnˈθjuːziæst]** `n` 热心人；爱好者
    ```
    He is a great sports enthusiast.
    他是个真正的体育爱好者
    ```

7. Pacific **[pəˈsɪfɪk]** `n` 太平洋
    ```
...
11. ventilation **[ˌventɪˈleɪʃn]** `n` 通风；通风系统
    ```
...
17. tunnel **[ˈtʌn(ə)l]** `n` 隧道
    ```
    He passed down the tunnel.
    他穿过了隧道
    ```

18. rediscover **[ˌriːdɪˈskʌvə(r)]** `vt` 重新发现
    ```
