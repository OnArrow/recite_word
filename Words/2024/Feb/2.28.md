...
2. stable **[ˈsteɪb(ə)l]** `adj` 稳定的，牢固的 `n` 马棚
    ```
...
5. frighten **[ˈfraɪt(ə)n]** `v` （使）惊吓，（使）惊恐
    ```
...
14. nervous **[ˈnɜːvəs]** `adj` 神经紧张的，紧张不安的
    ```
