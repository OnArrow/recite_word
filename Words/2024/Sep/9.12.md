...
3. busman **[ˈbʌsmən]** `n` 公交车司机
    ```
    He doesn't like his job as a busman.
    他不喜欢公交车司机这个工作
    ```

4. extent **[ɪkˈstent]** `n` 程度
    ```
    To some extent this was the truth.
    在某种程度上，这是事实
    ```

5. relieve **[rɪˈliːv]** `v` 减轻（问题的严重性）；缓解
    ```
...
12. suspicious **[səˈspɪʃəs]** `adj` 不信任的；怀疑的
    ```
