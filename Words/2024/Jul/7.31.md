...
5. numerous **[ˈnjuːmərəs]** `adj` 众多的，许多的
    ```
...
9. dismay **[dɪsˈmeɪ]** `v` （使）失望；（使）沮丧 `n` 失望
    ```
...
19. burst **[bɜːst]** `v` 爆裂，爆炸；胀开
    ```
    Her head felt as if it would burst.
    她觉得头要裂开了
    ```

20. doorknob **[ˈdɔːnɒb]** `n` 门把手
    ```
