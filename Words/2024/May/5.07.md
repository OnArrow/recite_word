...
1. dangerous **[ˈdeɪndʒərəs]** `adj` 危险的
    ```
...
7. then **[ðen]** `adv` （指过去）当时；（指将来）到那时；然后；
    ```
...
10. outstanding **[aʊtˈstændɪŋ]** `adj` 杰出的，优秀的
    ```
...
12. brilliant **[ˈbrɪliənt]** `adj` 成功的；才华横溢的
    ```
    The tunnel is a brilliant feat of engineering
    这条隧道是工程方面的辉煌成就
    ```

13. fantastic **[fænˈtæstɪk]** `adj` 极好的，非常棒的；极大的
    ```
    Fantastic! The real English breakfast
    太棒了！这就是真正的英式早餐
    ```

14. measure **[ˈmeʒə(r)]** `n` 计量工具

15. swagger **[ˈswæɡə(r)]** `adj` 漂亮的
