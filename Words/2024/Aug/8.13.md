...
2. officially **[əˈfɪʃəli]** `adv` 正式地；官方地
    ```
...
4. fortunate **[ˈfɔːtʃənət]** `adj` 幸运的
    ```
    I often think about those less fortunate than me.
    我经常想到那些不如我幸运的人
    ```

5. invasion **[ɪnˈveɪʒ(ə)n]** `n` 侵略；入侵
    ```
...
12. rediscover **[ˌriːdɪˈskʌvə(r)]** `vt` 重新发现
    ```
...
16. ventilation **[ˌventɪˈleɪʃn]** `n` 通风；通风系统
    ```
    The only ventilation comes from tiny sliding window.
    唯一的通风来自几扇小小的推拉窗
    ```

17. ought **[ɔːt]** `v` 应该（表义务、责任、必要等）
    ```
    You ought to ask a lawyer's advice.
    你应该问问律师的意见
    ```

18. admire **[ədˈmaɪə(r)]** `v` 钦佩，仰慕；欣赏
    ```
