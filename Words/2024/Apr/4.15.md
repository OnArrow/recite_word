...
6. mission **[ˈmɪʃ(ə)n]** `n` 军事行动；重要任务
    ```
...
20. schema **[ˈskiːmə]** `n` （计划或理论的）纲要，图解；模式
    ```
