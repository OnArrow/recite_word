...
6. sped **[sped]** `v` （speed 的过去式）

7. guilty **[ˈɡɪlti]** `adj` 内疚的；羞愧的
    ```
    I felt a wee bit guilty about it.
    我对此觉得有点惭愧
    ```

8. patience **[ˈpeɪʃ(ə)ns]** `n` 耐心
    ```
...
12. Benz **[benz]** `n` （汽车品牌）奔驰

13. punish **[ˈpʌnɪʃ]** `v` 惩罚，处罚
    ```
    Did you have to punish him very often when you trained him?
    你训练他的时候会经常惩罚他吗？
    ```

14. fur **[fɜː(r)]** `n` 裘衣；毛皮
    ```
...
19. eager **[ˈiːɡə(r)]** `adj` 热情的；热切的；渴望的
    ```
