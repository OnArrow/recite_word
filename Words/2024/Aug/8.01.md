...
10. rather **[ˈrɑːðə(r)]** `adv` 而不是；宁愿；相当
    ```
...
13. worthless **[ˈwɜːθləs]** `adj` 毫无价值的
    ```
    Critics say his painting are worthless.
    批评家们说他的画毫无价值
    ```

14. mine **[maɪn]** `pron` 我的 `n` 矿，矿井
    ```
    The accident happened through no fault of mine.
    发生事故并不是我的过错
    ```

15. trunk **[trʌŋk]** `n` （汽车）后备箱；箱子；树干
    ```
...
18. arm **[ɑːm]** `n` 手臂 `v` 武装
    ```
    A snake was twisting around his arm.
    一条蛇缠绕在他的手臂上
    ```

19. confident **[ˈkɒnfɪdənt]** `adj` 充满信心的
    ```
    She sounded more confident than she felt.
    她的语气听起来比她本人的感觉更有信心
    ```

20. obvious **[ˈɒbviəs]** `adj` 明确表示的；明显的；显而易见的
    ```
