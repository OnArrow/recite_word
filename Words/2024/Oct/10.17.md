...
6. profitably **[ˈprɒfɪtəbli]** `adv` 有益地
    ```
...
8. testimony **[ˈtestɪməni]** `n` 证词，证言
    ```
...
10. confinement **[kənˈfaɪnmənt]** `n` 监禁，关押
    ```
    She had been held in solitary confinement for four months.
    她曾被单独关押了4个月
    ```

11. compel **[kəmˈpel]** `v` 强迫
    ```
