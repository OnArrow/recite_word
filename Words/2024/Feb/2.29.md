...
7. beginning **[bɪˈɡɪnɪŋ]** `n` 开端；起源

8. bistro **[ˈbiːstrəʊ]** `n` 小酒馆
    ```
    We ate in the restaurant, as opposed to the bistro
    我们是在饭店吃的饭，而不是在小酒馆
    ```

9. independent **[ˌɪndɪˈpendənt]** `adj` 独立的，自治的；有主见的
    ```
