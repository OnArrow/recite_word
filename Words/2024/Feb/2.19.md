...
1. Asian **[ˈeɪʒ(ə)n]** `n` 亚洲人 `adj` 亚洲的
    ```
...
6. outlaw **[ˈaʊtlɔː]** `n` 逃犯；不法之徒
    ```
    This man is an outlaw to us
    这个人是我们要抓的逃犯
    ```

7. African **[ˈæfrɪkən]** `n` 非洲人 `adj` 非洲的；非洲人的
    ```
    It was the first time I had set foot on African soil
    那是我第一次踏上非洲大陆
    ```

8. combination **[ˌkɒmbɪˈneɪʃ(ə)n]** `n` 结合体；联合体；联合
    ```
...
10. Europe **[ˈjʊərəp]** n. 欧洲；欧盟
    ```
    He had thumbed all across Europe
    他搭乘便车游遍了欧洲
    ```

11. European **[ˌjʊərəˈpiːən]** `n` 欧洲人 `adj` 欧洲的；欧洲人的
    ```
