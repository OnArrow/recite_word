...
2. temptation **[tempˈteɪʃ(ə)n]** `n` 诱惑
    ```
...
6. circular **[ˈsɜːkjələ(r)]** `adj` 循环的，绕圈的；环形的，圆形的
    ```
...
8. upbeat **[ˈʌpbiːt]** `adj` 乐观的，积极向上的
    ```
